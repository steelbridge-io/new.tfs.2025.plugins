<?php
  ...
  if ( isset( $_POST[ 'sec2-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec2-dest-btn-title-1', wp_kses_post( $_POST[ 'sec2-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec2-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec2-dest-btn-title-2', wp_kses_post( $_POST[ 'sec2-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec2-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec2-dest-btn-title-3', wp_kses_post( $_POST[ 'sec2-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec2-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec2-dest-img-title-2', wp_kses_post( $_POST[ 'sec2-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec2-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec2-dest-img-desc-2', wp_kses_post( $_POST[ 'sec2-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec2-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec2-dest-img-title-3', wp_kses_post( $_POST[ 'sec2-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec2-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec2-dest-img-desc-3', wp_kses_post( $_POST[ 'sec2-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec3-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-img-title-1', wp_kses_post( $_POST[ 'sec3-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec3-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-img-desc-1', wp_kses_post( $_POST[ 'sec3-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec3-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-btn-title-1', wp_kses_post( $_POST[ 'sec3-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec3-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-btn-title-2', wp_kses_post( $_POST[ 'sec3-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec3-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-btn-title-3', wp_kses_post( $_POST[ 'sec3-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec3-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-img-title-2', wp_kses_post( $_POST[ 'sec3-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec3-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-img-desc-2', wp_kses_post( $_POST[ 'sec3-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec3-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-img-title-3', wp_kses_post( $_POST[ 'sec3-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec3-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec3-dest-img-desc-3', wp_kses_post( $_POST[ 'sec3-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec4-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-img-title-1', wp_kses_post( $_POST[ 'sec4-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec4-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-img-desc-1', wp_kses_post( $_POST[ 'sec4-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec4-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-btn-title-1', wp_kses_post( $_POST[ 'sec4-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec4-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-btn-title-2', wp_kses_post( $_POST[ 'sec4-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec4-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-btn-title-3', wp_kses_post( $_POST[ 'sec4-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec4-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-img-title-2', wp_kses_post( $_POST[ 'sec4-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec4-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-img-desc-2', wp_kses_post( $_POST[ 'sec4-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec4-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-img-title-3', wp_kses_post( $_POST[ 'sec4-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec4-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec4-dest-img-desc-3', wp_kses_post( $_POST[ 'sec4-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec5-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-img-title-1', wp_kses_post( $_POST[ 'sec5-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec5-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-img-desc-1', wp_kses_post( $_POST[ 'sec5-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec5-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-btn-title-1', wp_kses_post( $_POST[ 'sec5-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec5-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-btn-title-2', wp_kses_post( $_POST[ 'sec5-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec5-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-btn-title-3', wp_kses_post( $_POST[ 'sec5-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec5-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-img-title-2', wp_kses_post( $_POST[ 'sec5-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec5-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-img-desc-2', wp_kses_post( $_POST[ 'sec5-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec5-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-img-title-3', wp_kses_post( $_POST[ 'sec5-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec5-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec5-dest-img-desc-3', wp_kses_post( $_POST[ 'sec5-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec6-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-img-title-1', wp_kses_post( $_POST[ 'sec6-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec6-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-img-desc-1', wp_kses_post( $_POST[ 'sec6-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec6-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-btn-title-1', wp_kses_post( $_POST[ 'sec6-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec6-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-btn-title-2', wp_kses_post( $_POST[ 'sec6-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec6-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-btn-title-3', wp_kses_post( $_POST[ 'sec6-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec6-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-img-title-2', wp_kses_post( $_POST[ 'sec6-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec6-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-img-desc-2', wp_kses_post( $_POST[ 'sec6-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec6-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-img-title-3', wp_kses_post( $_POST[ 'sec6-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec6-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec6-dest-img-desc-3', wp_kses_post( $_POST[ 'sec6-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec7-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-img-title-1', wp_kses_post( $_POST[ 'sec7-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec7-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-img-desc-1', wp_kses_post( $_POST[ 'sec7-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec7-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-btn-title-1', wp_kses_post( $_POST[ 'sec7-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec7-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-btn-title-2', wp_kses_post( $_POST[ 'sec7-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec7-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-btn-title-3', wp_kses_post( $_POST[ 'sec7-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec7-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-img-title-2', wp_kses_post( $_POST[ 'sec7-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec7-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-img-desc-2', wp_kses_post( $_POST[ 'sec7-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec7-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-img-title-3', wp_kses_post( $_POST[ 'sec7-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec7-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec7-dest-img-desc-3', wp_kses_post( $_POST[ 'sec7-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec8-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-img-title-1', wp_kses_post( $_POST[ 'sec8-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec8-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-img-desc-1', wp_kses_post( $_POST[ 'sec8-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec8-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-btn-title-1', wp_kses_post( $_POST[ 'sec8-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec8-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-btn-title-2', wp_kses_post( $_POST[ 'sec8-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec8-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-btn-title-3', wp_kses_post( $_POST[ 'sec8-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec8-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-img-title-2', wp_kses_post( $_POST[ 'sec8-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec8-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-img-desc-2', wp_kses_post( $_POST[ 'sec8-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec8-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-img-title-3', wp_kses_post( $_POST[ 'sec8-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec8-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec8-dest-img-desc-3', wp_kses_post( $_POST[ 'sec8-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec9-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-img-title-1', wp_kses_post( $_POST[ 'sec9-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec9-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-img-desc-1', wp_kses_post( $_POST[ 'sec9-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec9-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-btn-title-1', wp_kses_post( $_POST[ 'sec9-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec9-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-btn-title-2', wp_kses_post( $_POST[ 'sec9-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec9-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-btn-title-3', wp_kses_post( $_POST[ 'sec9-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec9-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-img-title-2', wp_kses_post( $_POST[ 'sec9-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec9-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-img-desc-2', wp_kses_post( $_POST[ 'sec9-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec9-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-img-title-3', wp_kses_post( $_POST[ 'sec9-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec9-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec9-dest-img-desc-3', wp_kses_post( $_POST[ 'sec9-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec10-dest-img-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-img-title-1', wp_kses_post( $_POST[ 'sec10-dest-img-title-1' ] ) );
  }

  if( isset( $_POST[ 'sec10-dest-img-desc-1' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-img-desc-1', wp_kses_post( $_POST[ 'sec10-dest-img-desc-1' ] ) );
  }

  if ( isset( $_POST[ 'sec10-dest-btn-title-1' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-btn-title-1', wp_kses_post( $_POST[ 'sec10-dest-btn-title-1' ] ) );
  }

  if ( isset( $_POST[ 'sec10-dest-btn-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-btn-title-2', wp_kses_post( $_POST[ 'sec10-dest-btn-title-2' ] ) );
  }

  if ( isset( $_POST[ 'sec10-dest-btn-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-btn-title-3', wp_kses_post( $_POST[ 'sec10-dest-btn-title-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec10-dest-img-title-2' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-img-title-2', wp_kses_post( $_POST[ 'sec10-dest-img-title-2' ] ) );
  }

  if( isset( $_POST[ 'sec10-dest-img-desc-2' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-img-desc-2', wp_kses_post( $_POST[ 'sec10-dest-img-desc-2' ] ) );
  }
  ...
  if( isset( $_POST[ 'sec10-dest-img-title-3' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-img-title-3', wp_kses_post( $_POST[ 'sec10-dest-img-title-3' ] ) );
  }

  if( isset( $_POST[ 'sec10-dest-img-desc-3' ] ) ) {
   update_post_meta( $post_id, 'sec10-dest-img-desc-3', wp_kses_post( $_POST[ 'sec10-dest-img-desc-3' ] ) );
  }
  ...
  if( isset( $_POST[ 'multi-dest-cta-title' ] ) ) {
   update_post_meta( $post_id, 'multi-dest-cta-title', wp_kses_post( $_POST[ 'multi-dest-cta-title' ] ) );
  }

  if( isset( $_POST[ 'multi-dest-cta-text' ] ) ) {
   update_post_meta( $post_id, 'multi-dest-cta-text', wp_kses_post( $_POST[ 'multi-dest-cta-text' ] ) );
  }
