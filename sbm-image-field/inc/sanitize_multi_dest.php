...
function multi_dest_save( $post_id ) {
	 ...
	 if( isset( $_POST[ 'sec1-dest-img-1' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-img-1', $_POST[ 'sec1-dest-img-1' ] );
	 }

	if( isset( $_POST[ 'sec1-dest-title-1' ] ) ) {
	 update_post_meta( $post_id, 'sec1-dest-title-1', $_POST[ 'sec1-dest-title-1' ] );
	}

	if( isset( $_POST[ 'sec1-dest-textarea-1' ] ) ) {
	 update_post_meta( $post_id, 'sec1-dest-textarea-1', $_POST[ 'sec1-dest-textarea-1' ] );
	}

	 if( isset( $_POST[ 'sec1-dest-readmore-1' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-readmore-1', $_POST[ 'sec1-dest-readmore-1' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-img-2' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-img-2', $_POST[ 'sec1-dest-img-2' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-title-2' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-title-2', $_POST[ 'sec1-dest-title-2' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-textarea-2' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-textarea-2', $_POST[ 'sec1-dest-textarea-2' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-readmore-2' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-readmore-2', $_POST[ 'sec1-dest-readmore-2' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-img-3' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-img-3', $_POST[ 'sec1-dest-img-3' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-title-3' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-title-3', $_POST[ 'sec1-dest-title-3' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-textarea-3' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-textarea-3', $_POST[ 'sec1-dest-textarea-3' ] );
	 }

	 if( isset( $_POST[ 'sec1-dest-readmore-3' ] ) ) {
		update_post_meta( $post_id, 'sec1-dest-readmore-3', $_POST[ 'sec1-dest-readmore-3' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-img-1' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-img-1', $_POST[ 'sec2-dest-img-1' ] );
	 }

	 if( isset( $_POST[ 'sec2-dest-title-1' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-title-1', $_POST[ 'sec2-dest-title-1' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-textarea-1' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-textarea-1', $_POST[ 'sec2-dest-textarea-1' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-readmore-1' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-readmore-1', $_POST[ 'sec2-dest-readmore-1' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-img-2' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-img-2', $_POST[ 'sec2-dest-img-2' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-title-2' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-title-2', $_POST[ 'sec2-dest-title-2' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-textarea-2' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-textarea-2', $_POST[ 'sec2-dest-textarea-2' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-readmore-2' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-readmore-2', $_POST[ 'sec2-dest-readmore-2' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-img-3' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-img-3', $_POST[ 'sec2-dest-img-3' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-title-3' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-title-3', $_POST[ 'sec2-dest-title-3' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-textarea-3' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-textarea-3', $_POST[ 'sec2-dest-textarea-3' ] );
	 }
	 
	 if( isset( $_POST[ 'sec2-dest-readmore-3' ] ) ) {
		 update_post_meta( $post_id, 'sec2-dest-readmore-3', $_POST[ 'sec2-dest-readmore-3' ] );
	 }

	if( isset( $_POST[ 'sec3-dest-img-1' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-img-1', $_POST[ 'sec3-dest-img-1' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-title-1' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-title-1', $_POST[ 'sec3-dest-title-1' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-textarea-1' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-textarea-1', $_POST[ 'sec3-dest-textarea-1' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-readmore-1' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-readmore-1', $_POST[ 'sec3-dest-readmore-1' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-img-2' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-img-2', $_POST[ 'sec3-dest-img-2' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-title-2' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-title-2', $_POST[ 'sec3-dest-title-2' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-textarea-2' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-textarea-2', $_POST[ 'sec3-dest-textarea-2' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-readmore-2' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-readmore-2', $_POST[ 'sec3-dest-readmore-2' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-img-3' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-img-3', $_POST[ 'sec3-dest-img-3' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-title-3' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-title-3', $_POST[ 'sec3-dest-title-3' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-textarea-3' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-textarea-3', $_POST[ 'sec3-dest-textarea-3' ] );
	}
	
	if( isset( $_POST[ 'sec3-dest-readmore-3' ] ) ) {
	 update_post_meta( $post_id, 'sec3-dest-readmore-3', $_POST[ 'sec3-dest-readmore-3' ] );
	}

    if( isset( $_POST[ 'sec4-dest-img-1' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-img-1', $_POST[ 'sec4-dest-img-1' ] );
    }

    if( isset( $_POST[ 'sec4-dest-title-1' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-title-1', $_POST[ 'sec4-dest-title-1' ] );
    }

    if( isset( $_POST[ 'sec4-dest-textarea-1' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-textarea-1', $_POST[ 'sec4-dest-textarea-1' ] );
    }

    if( isset( $_POST[ 'sec4-dest-readmore-1' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-readmore-1', $_POST[ 'sec4-dest-readmore-1' ] );
    }

    if( isset( $_POST[ 'sec4-dest-img-2' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-img-2', $_POST[ 'sec4-dest-img-2' ] );
    }

    if( isset( $_POST[ 'sec4-dest-title-2' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-title-2', $_POST[ 'sec4-dest-title-2' ] );
    }

    if( isset( $_POST[ 'sec4-dest-textarea-2' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-textarea-2', $_POST[ 'sec4-dest-textarea-2' ] );
    }

    if( isset( $_POST[ 'sec4-dest-readmore-2' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-readmore-2', $_POST[ 'sec4-dest-readmore-2' ] );
    }

    if( isset( $_POST[ 'sec4-dest-img-3' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-img-3', $_POST[ 'sec4-dest-img-3' ] );
    }

    if( isset( $_POST[ 'sec4-dest-title-3' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-title-3', $_POST[ 'sec4-dest-title-3' ] );
    }

    if( isset( $_POST[ 'sec4-dest-textarea-3' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-textarea-3', $_POST[ 'sec4-dest-textarea-3' ] );
    }

    if( isset( $_POST[ 'sec4-dest-readmore-3' ] ) ) {
        update_post_meta( $post_id, 'sec4-dest-readmore-3', $_POST[ 'sec4-dest-readmore-3' ] );
    }

    if( isset( $_POST[ 'sec5-dest-img-1' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-img-1', $_POST[ 'sec5-dest-img-1' ] );
    }

    if( isset( $_POST[ 'sec5-dest-title-1' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-title-1', $_POST[ 'sec5-dest-title-1' ] );
    }

    if( isset( $_POST[ 'sec5-dest-textarea-1' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-textarea-1', $_POST[ 'sec5-dest-textarea-1' ] );
    }

    if( isset( $_POST[ 'sec5-dest-readmore-1' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-readmore-1', $_POST[ 'sec5-dest-readmore-1' ] );
    }

    if( isset( $_POST[ 'sec5-dest-img-2' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-img-2', $_POST[ 'sec5-dest-img-2' ] );
    }

    if( isset( $_POST[ 'sec5-dest-title-2' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-title-2', $_POST[ 'sec5-dest-title-2' ] );
    }

    if( isset( $_POST[ 'sec5-dest-textarea-2' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-textarea-2', $_POST[ 'sec5-dest-textarea-2' ] );
    }

    if( isset( $_POST[ 'sec5-dest-readmore-2' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-readmore-2', $_POST[ 'sec5-dest-readmore-2' ] );
    }

    if( isset( $_POST[ 'sec5-dest-img-3' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-img-3', $_POST[ 'sec5-dest-img-3' ] );
    }

    if( isset( $_POST[ 'sec5-dest-title-3' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-title-3', $_POST[ 'sec5-dest-title-3' ] );
    }

    if( isset( $_POST[ 'sec5-dest-textarea-3' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-textarea-3', $_POST[ 'sec5-dest-textarea-3' ] );
    }

    if( isset( $_POST[ 'sec5-dest-readmore-3' ] ) ) {
        update_post_meta( $post_id, 'sec5-dest-readmore-3', $_POST[ 'sec5-dest-readmore-3' ] );
    }

    if( isset( $_POST[ 'sec6-dest-img-1' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-img-1', $_POST[ 'sec6-dest-img-1' ] );
    }

    if( isset( $_POST[ 'sec6-dest-title-1' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-title-1', $_POST[ 'sec6-dest-title-1' ] );
    }

    if( isset( $_POST[ 'sec6-dest-textarea-1' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-textarea-1', $_POST[ 'sec6-dest-textarea-1' ] );
    }

    if( isset( $_POST[ 'sec6-dest-readmore-1' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-readmore-1', $_POST[ 'sec6-dest-readmore-1' ] );
    }

    if( isset( $_POST[ 'sec6-dest-img-2' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-img-2', $_POST[ 'sec6-dest-img-2' ] );
    }

    if( isset( $_POST[ 'sec6-dest-title-2' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-title-2', $_POST[ 'sec6-dest-title-2' ] );
    }

    if( isset( $_POST[ 'sec6-dest-textarea-2' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-textarea-2', $_POST[ 'sec6-dest-textarea-2' ] );
    }

    if( isset( $_POST[ 'sec6-dest-readmore-2' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-readmore-2', $_POST[ 'sec6-dest-readmore-2' ] );
    }

    if( isset( $_POST[ 'sec6-dest-img-3' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-img-3', $_POST[ 'sec6-dest-img-3' ] );
    }

    if( isset( $_POST[ 'sec6-dest-title-3' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-title-3', $_POST[ 'sec6-dest-title-3' ] );
    }

    if( isset( $_POST[ 'sec6-dest-textarea-3' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-textarea-3', $_POST[ 'sec6-dest-textarea-3' ] );
    }

    if( isset( $_POST[ 'sec6-dest-readmore-3' ] ) ) {
        update_post_meta( $post_id, 'sec6-dest-readmore-3', $_POST[ 'sec6-dest-readmore-3' ] );
    }

    if( isset( $_POST[ 'sec7-dest-img-1' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-img-1', $_POST[ 'sec7-dest-img-1' ] );
    }

    if( isset( $_POST[ 'sec7-dest-title-1' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-title-1', $_POST[ 'sec7-dest-title-1' ] );
    }

    if( isset( $_POST[ 'sec7-dest-textarea-1' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-textarea-1', $_POST[ 'sec7-dest-textarea-1' ] );
    }

    if( isset( $_POST[ 'sec7-dest-readmore-1' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-readmore-1', $_POST[ 'sec7-dest-readmore-1' ] );
    }

    if( isset( $_POST[ 'sec7-dest-img-2' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-img-2', $_POST[ 'sec7-dest-img-2' ] );
    }

    if( isset( $_POST[ 'sec7-dest-title-2' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-title-2', $_POST[ 'sec7-dest-title-2' ] );
    }

    if( isset( $_POST[ 'sec7-dest-textarea-2' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-textarea-2', $_POST[ 'sec7-dest-textarea-2' ] );
    }

    if( isset( $_POST[ 'sec7-dest-readmore-2' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-readmore-2', $_POST[ 'sec7-dest-readmore-2' ] );
    }

    if( isset( $_POST[ 'sec7-dest-img-3' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-img-3', $_POST[ 'sec7-dest-img-3' ] );
    }

    if( isset( $_POST[ 'sec7-dest-title-3' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-title-3', $_POST[ 'sec7-dest-title-3' ] );
    }

    if( isset( $_POST[ 'sec7-dest-textarea-3' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-textarea-3', $_POST[ 'sec7-dest-textarea-3' ] );
    }

    if( isset( $_POST[ 'sec7-dest-readmore-3' ] ) ) {
        update_post_meta( $post_id, 'sec7-dest-readmore-3', $_POST[ 'sec7-dest-readmore-3' ] );
    }

    if( isset( $_POST[ 'sec8-dest-img-1' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-img-1', $_POST[ 'sec8-dest-img-1' ] );
    }

    if( isset( $_POST[ 'sec8-dest-title-1' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-title-1', $_POST[ 'sec8-dest-title-1' ] );
    }

    if( isset( $_POST[ 'sec8-dest-textarea-1' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-textarea-1', $_POST[ 'sec8-dest-textarea-1' ] );
    }

    if( isset( $_POST[ 'sec8-dest-readmore-1' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-readmore-1', $_POST[ 'sec8-dest-readmore-1' ] );
    }

    if( isset( $_POST[ 'sec8-dest-img-2' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-img-2', $_POST[ 'sec8-dest-img-2' ] );
    }

    if( isset( $_POST[ 'sec8-dest-title-2' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-title-2', $_POST[ 'sec8-dest-title-2' ] );
    }

    if( isset( $_POST[ 'sec8-dest-textarea-2' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-textarea-2', $_POST[ 'sec8-dest-textarea-2' ] );
    }

    if( isset( $_POST[ 'sec8-dest-readmore-2' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-readmore-2', $_POST[ 'sec8-dest-readmore-2' ] );
    }

    if( isset( $_POST[ 'sec8-dest-img-3' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-img-3', $_POST[ 'sec8-dest-img-3' ] );
    }

    if( isset( $_POST[ 'sec8-dest-title-3' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-title-3', $_POST[ 'sec8-dest-title-3' ] );
    }

    if( isset( $_POST[ 'sec8-dest-textarea-3' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-textarea-3', $_POST[ 'sec8-dest-textarea-3' ] );
    }

    if( isset( $_POST[ 'sec8-dest-readmore-3' ] ) ) {
        update_post_meta( $post_id, 'sec8-dest-readmore-3', $_POST[ 'sec8-dest-readmore-3' ] );
    }

    if( isset( $_POST[ 'sec9-dest-img-1' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-img-1', $_POST[ 'sec9-dest-img-1' ] );
    }

    if( isset( $_POST[ 'sec9-dest-title-1' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-title-1', $_POST[ 'sec9-dest-title-1' ] );
    }

    if( isset( $_POST[ 'sec9-dest-textarea-1' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-textarea-1', $_POST[ 'sec9-dest-textarea-1' ] );
    }

    if( isset( $_POST[ 'sec9-dest-readmore-1' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-readmore-1', $_POST[ 'sec9-dest-readmore-1' ] );
    }

    if( isset( $_POST[ 'sec9-dest-img-2' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-img-2', $_POST[ 'sec9-dest-img-2' ] );
    }

    if( isset( $_POST[ 'sec9-dest-title-2' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-title-2', $_POST[ 'sec9-dest-title-2' ] );
    }

    if( isset( $_POST[ 'sec9-dest-textarea-2' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-textarea-2', $_POST[ 'sec9-dest-textarea-2' ] );
    }

    if( isset( $_POST[ 'sec9-dest-readmore-2' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-readmore-2', $_POST[ 'sec9-dest-readmore-2' ] );
    }

    if( isset( $_POST[ 'sec9-dest-img-3' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-img-3', $_POST[ 'sec9-dest-img-3' ] );
    }

    if( isset( $_POST[ 'sec9-dest-title-3' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-title-3', $_POST[ 'sec9-dest-title-3' ] );
    }

    if( isset( $_POST[ 'sec9-dest-textarea-3' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-textarea-3', $_POST[ 'sec9-dest-textarea-3' ] );
    }

    if( isset( $_POST[ 'sec9-dest-readmore-3' ] ) ) {
        update_post_meta( $post_id, 'sec9-dest-readmore-3', $_POST[ 'sec9-dest-readmore-3' ] );
    }

    if( isset( $_POST[ 'sec10-dest-img-1' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-img-1', $_POST[ 'sec10-dest-img-1' ] );
    }

    if( isset( $_POST[ 'sec10-dest-title-1' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-title-1', $_POST[ 'sec10-dest-title-1' ] );
    }

    if( isset( $_POST[ 'sec10-dest-textarea-1' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-textarea-1', $_POST[ 'sec10-dest-textarea-1' ] );
    }

    if( isset( $_POST[ 'sec10-dest-readmore-1' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-readmore-1', $_POST[ 'sec10-dest-readmore-1' ] );
    }

    if( isset( $_POST[ 'sec10-dest-img-2' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-img-2', $_POST[ 'sec10-dest-img-2' ] );
    }

    if( isset( $_POST[ 'sec10-dest-title-2' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-title-2', $_POST[ 'sec10-dest-title-2' ] );
    }

    if( isset( $_POST[ 'sec10-dest-textarea-2' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-textarea-2', $_POST[ 'sec10-dest-textarea-2' ] );
    }

    if( isset( $_POST[ 'sec10-dest-readmore-2' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-readmore-2', $_POST[ 'sec10-dest-readmore-2' ] );
    }

    if( isset( $_POST[ 'sec10-dest-img-3' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-img-3', $_POST[ 'sec10-dest-img-3' ] );
    }

    if( isset( $_POST[ 'sec10-dest-title-3' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-title-3', $_POST[ 'sec10-dest-title-3' ] );
    }

    if( isset( $_POST[ 'sec10-dest-textarea-3' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-textarea-3', $_POST[ 'sec10-dest-textarea-3' ] );
    }

    if( isset( $_POST[ 'sec10-dest-readmore-3' ] ) ) {
        update_post_meta( $post_id, 'sec10-dest-readmore-3', $_POST[ 'sec10-dest-readmore-3' ] );
    }
