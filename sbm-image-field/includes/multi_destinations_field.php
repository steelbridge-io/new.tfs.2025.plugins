<?php
 ...
 add_action('add_meta_boxes', 'multi_dest_field');
	...
	if (!empty($post)) {
	 ...
	 foreach ($types as $type) {
		if ($pageTemplate == 'page-templates/multi-destination-template.php') {
		 add_meta_box('multi_dest_meta', __('Content &amp; Images', 'the-fly-shop'), 'multi_dest_callback', $type, 'normal', 'high');
		}
	 }
	}
 }
...
// Outputs the content of the meta box
 ...
 {
	wp_nonce_field(basename(__FILE__), 'multi_dest_nonce');
    ...
    <div class="sections-meta-cont">
        ...
        <input style="width:100%;" type="url" name="sections-video" id="sections-video" value="<?php if (isset ($multi_dest_stored_meta['sections-video'])) echo $multi_dest_stored_meta['sections-video'][0]; ?>"/>
    ...
    <div class="sections-meta-cont">
        ...
        <input style="width:75%;" type="text" name="sections-video-poster" id="sections-video-poster" value="<?php if (isset ($multi_dest_stored_meta['sections-video-poster'])) echo $multi_dest_stored_meta['sections-video-poster'][0]; ?>"/>
    ...
    <!-- ==== SECTIONS HERO IMAGE ==== -->
        ...
        <input style="width:75%;" type="text" name="sections-hero-image" id="sections-hero-image" value="<?php if (isset ($multi_dest_stored_meta['sections-hero-image'])) echo $multi_dest_stored_meta['sections-hero-image'][0]; ?>"/>
     ...
     <p>
         ...
         <input style="width:75%;" type="text" name="sections-logo" id="sections-logo"
                value="<?php if (isset ($multi_dest_stored_meta['sections-logo'])) echo $multi_dest_stored_meta['sections-logo'][0]; ?>"/>
     ...
     <p>
         ...
         <input style="width:100%;" type="text" name="sections-description" id="sections-description"
                value="<?php if (isset ($multi_dest_stored_meta['sections-description'])) echo $multi_dest_stored_meta['sections-description'][0]; ?>"/>
                 ...
                 <div class="sections-row-content">
                     <label for="sections-csel-checkbox">
                         <input type="checkbox" name="sections-csel-checkbox" id="sections-csel-checkbox"
                                value="yes" <?php if (isset ($multi_dest_stored_meta['sections-csel-checkbox'])) checked($multi_dest_stored_meta['sections-csel-checkbox'][0], 'yes'); ?> />
                     ...
                     <div role="tabpanel" class="tab-pane fade in active" id="sectionscselimage1">
                         ...
                         <p>
                             ...
                             <input style="width: 75%;" type="text" name="sections-csel-1-link" id="sections-csel-1-link"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-1-link'])) echo $multi_dest_stored_meta['sections-csel-1-link'][0]; ?>"/>
                         ...
                         <p>
                             ...
                             <input style="width:75%;" type="text" name="sections-csel-1-img" id="sections-csel-1-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-1-img'])) echo $multi_dest_stored_meta['sections-csel-1-img'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="sectionscselimage2">
                         ...
                         <p>
                             ...
                             <input style="width: 75%;" type="text" name="sections-csel-2-link" id="sections-csel-2-link"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-2-link'])) echo $multi_dest_stored_meta['sections-csel-2-link'][0]; ?>"/>
                         ...
                         <p>
                             ...
                             <input style="width:75%;" type="text" name="sections-csel-2-img" id="sections-csel-2-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-2-img'])) echo $multi_dest_stored_meta['sections-csel-2-img'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="sectionscselimage3">
                         ...
                         <p>
                             ...
                             <input style="width: 75%;" type="text" name="sections-csel-3-link" id="sections-csel-3-link"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-3-link'])) echo $multi_dest_stored_meta['sections-csel-3-link'][0]; ?>"/>
                         ...
                         <p>
                             ...
                             <input style="width:75%;" type="text" name="sections-csel-3-img" id="sections-csel-3-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-3-img'])) echo $multi_dest_stored_meta['sections-csel-3-img'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="sectionscselimage4">
                         ...
                         <p>
                             ...
                             <input style="width: 75%;" type="text" name="sections-csel-4-link" id="sections-csel-4-link"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-4-link'])) echo $multi_dest_stored_meta['sections-csel-4-link'][0]; ?>"/>
                         ...
                         <p>
                             ...
                             <input style="width:75%;" type="text" name="sections-csel-4-img" id="sections-csel-4-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-4-img'])) echo $multi_dest_stored_meta['sections-csel-4-img'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="sectionscselimage5">
                         ...
                         <p>
                             ...
                             <input style="width: 75%;" type="text" name="sections-csel-5-link" id="sections-csel-5-link"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-5-link'])) echo $multi_dest_stored_meta['sections-csel-5-link'][0]; ?>"/>
                         ...
                         <p>
                             ...
                             <input style="width:75%;" type="text" name="sections-csel-5-img" id="sections-csel-5-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-5-img'])) echo $multi_dest_stored_meta['sections-csel-5-img'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="sectionscselimage6">
                         ...
                         <p>
                             ...
                             <input style="width: 75%;" type="text" name="sections-csel-6-link" id="sections-csel-6-link"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-6-link'])) echo $multi_dest_stored_meta['sections-csel-6-link'][0]; ?>"/>
                         ...
                         <p>
                             ...
                             <input style="width:75%;" type="text" name="sections-csel-6-img" id="sections-csel-6-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-csel-6-img'])) echo $multi_dest_stored_meta['sections-csel-6-img'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in active" id="sectionsimage1">
                         ...
                         <p> <!-- ==== SECTION #1 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-1-title" id="sections-1-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-1-title'])) echo $multi_dest_stored_meta['sections-1-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #1 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-1-textarea"
                                       id="sections-1-textarea"><?php if (isset ($multi_dest_stored_meta['sections-1-textarea'])) echo $multi_dest_stored_meta['sections-1-textarea'][0]; ?></textarea>
                         ...
                         <p> <!-- ==== SECTION #1 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-1-readmore"
                                       id="sections-1-readmore"><?php if (isset ($multi_dest_stored_meta['sections-1-readmore'])) echo $multi_dest_stored_meta['sections-1-readmore'][0]; ?></textarea>
                         ...
                         <p> <!-- ==== SECTION #1 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-1-image" id="sections-1-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-1-image'])) echo $multi_dest_stored_meta['sections-1-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #1 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-1-video" id="sections-1-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-1-video'])) echo $multi_dest_stored_meta['sections-1-video'][0]; ?>"/>
                         ...
                         <p> <!-- ==== CAROUSEL IMAGE #1 ==== -->
                             ...
                             <label for="multidest-carousel-1-img"
                                    class="sections-1-image"><?php _e('<strong>Carousel Image &#35;1</strong>', 'the-fly-shop'); ?></label><br>
                             <input type="text" style="width: 75%;" name="multidest-carousel-1-img" id="multidest-carousel-1-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['multidest-carousel-1-img'])) echo $multi_dest_stored_meta['multidest-carousel-1-img'][0]; ?>"/><br><br>
                             <input type="button" id="multidest-carousel-1-img-button" class="button"
                                    value="<?php _e('Choose or Upload an Image', 'the-fly-shop'); ?>"/>

                         </p>
                         <p> <!-- ==== SECTION #1 MULTI-DESTINATION TITLE ==== -->

                          <strong><label for="sections-1-multidest-title"
                                         class="sections-1-multidest-title"><?php _e('Section &#35;1 Multi-Destination Title', 'the-fly-shop'); ?></label></strong><br>
                          <input style="width:50%;" type="text" name="sections-1-multidest-title" id="sections-1-multidest-title"
                                 value="<?php if (isset ($multi_dest_stored_meta['sections-1-multidest-title'])) echo $multi_dest_stored_meta['sections-1-multidest-title'][0]; ?>"/>

                         </p>
                         <p> <!-- ==== SECTION #1 MULTI-SECTION TEXT AREA ==== -->

                          <strong><label for="sections-1-multidest-textarea"
                                         class="sections-1-multidest-textarea"><?php _e('Section &#35;1 Multi-Destination Text Area', 'the-fly-shop') ?></label></strong>

                          <textarea style="width: 100%;" rows="4" name="sections-1-multidest-textarea"
                                    id="sections-1-multidest-textarea"><?php if (isset ($multi_dest_stored_meta['sections-1-multidest-textarea'])) echo $multi_dest_stored_meta['sections-1-multidest-textarea'][0]; ?></textarea>

                         </p>
                         <p> <!-- ==== SECTION #1 READ MORE ==== -->

                          <strong><label for="sections-1-multidest-readmore"
                                         class="sections-1-multidest-readmore"><?php _e('<strong>Section &#35;1 Mult-Destination Read More</strong>', 'the-fly-shop') ?></label></strong>

                          <textarea style="width: 100%;" rows="4" name="sections-1-multidest-readmore"
                                    id="sections-1-multidest-readmore"><?php if (isset ($multi_dest_stored_meta['sections-1-multidest-readmore'])) echo $multi_dest_stored_meta['sections-1-multidest-readmore'][0]; ?></textarea>

                         </p>
                         <p> <!-- ==== CAROUSEL IMAGE #2 ==== -->

                             <label for="multidest-carousel-2-img"
                                    class="sections-2-image"><?php _e('<strong>Carousel Image &#35;2</strong>', 'the-fly-shop'); ?></label><br>
                             <input type="text" style="width: 75%;" name="multidest-carousel-2-img" id="multidest-carousel-2-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['multidest-carousel-2-img'])) echo $multi_dest_stored_meta['multidest-carousel-2-img'][0]; ?>"/><br><br>
                             <input type="button" id="multidest-carousel-2-img-button" class="button"
                                    value="<?php _e('Choose or Upload an Image', 'the-fly-shop'); ?>"/>
                         ...
                         <p> <!-- ==== SECTION #2 MULTI-DESTINATION TITLE ==== -->
                          ...
                          <strong><label for="sections-2-multidest-title"
                                         class="sections-2-multidest-title"><?php _e('Section &#35;2 Multi-Destination Title', 'the-fly-shop'); ?></label></strong><br>
                          <input style="width:50%;" type="text" name="sections-2-multidest-title" id="sections-2-multidest-title"
                                 value="<?php if (isset ($multi_dest_stored_meta['sections-2-multidest-title'])) echo $multi_dest_stored_meta['sections-2-multidest-title'][0]; ?>"/>

                         </p>
                         <p> <!-- ==== SECTION #2 MULTI-SECTION TEXT AREA ==== -->

                          <strong><label for="sections-2-multidest-textarea"
                                         class="sections-2-multidest-textarea"><?php _e('Section &#35;2 Multi-Destination Text Area', 'the-fly-shop') ?></label></strong>

                          <textarea style="width: 100%;" rows="4" name="sections-2-multidest-textarea"
                                    id="sections-2-multidest-textarea"><?php if (isset ($multi_dest_stored_meta['sections-2-multidest-textarea'])) echo $multi_dest_stored_meta['sections-2-multidest-textarea'][0]; ?></textarea>

                         </p>
                         <p> <!-- ==== SECTION #2 READ MORE ==== -->

                          <strong><label for="sections-2-multidest-readmore"
                                         class="sections-2-multidest-readmore"><?php _e('<strong>Section &#35;2 Mult-Destination Read More</strong>', 'the-fly-shop') ?></label></strong>

                          <textarea style="width: 100%;" rows="4" name="sections-2-multidest-readmore"
                                    id="sections-2-multidest-readmore"><?php if (isset ($multi_dest_stored_meta['sections-2-multidest-readmore'])) echo $multi_dest_stored_meta['sections-2-multidest-readmore'][0]; ?></textarea>
                      ...
                      <p> <!-- ==== CAROUSEL IMAGE #3 ==== -->
                             ...
                             <label for="multidest-carousel-3-img"
                                    class="sections-3-image"><?php _e('<strong>Carousel Image &#35;3</strong>', 'the-fly-shop'); ?></label><br>
                             <input type="text" style="width: 75%;" name="multidest-carousel-3-img" id="multidest-carousel-3-img"
                                    value="<?php if (isset ($multi_dest_stored_meta['multidest-carousel-3-img'])) echo $multi_dest_stored_meta['multidest-carousel-3-img'][0]; ?>"/><br><br>
                             <input type="button" id="multidest-carousel-3-img-button" class="button"
                                    value="<?php _e('Choose or Upload an Image', 'the-fly-shop'); ?>"/>
                         ...
                         <p> <!-- ==== SECTION #3 MULTI-DESTINATION TITLE ==== -->
                          ...
                          <strong><label for="sections-3-multidest-title"
                                         class="sections-3-multidest-title"><?php _e('Section &#35;3 Multi-Destination Title', 'the-fly-shop'); ?></label></strong><br>
                          <input style="width:50%;" type="text" name="sections-3-multidest-title" id="sections-3-multidest-title"
                                 value="<?php if (isset ($multi_dest_stored_meta['sections-3-multidest-title'])) echo $multi_dest_stored_meta['sections-3-multidest-title'][0]; ?>"/>

                         </p>
                         <p> <!-- ==== SECTION #3 MULTI-SECTION TEXT AREA ==== -->

                          <strong><label for="sections-3-multidest-textarea"
                                         class="sections-3-multidest-textarea"><?php _e('Section &#35;3 Multi-Destination Text Area', 'the-fly-shop') ?></label></strong>

                          <textarea style="width: 100%;" rows="4" name="sections-3-multidest-textarea"
                                    id="sections-3-multidest-textarea"><?php if (isset ($multi_dest_stored_meta['sections-3-multidest-textarea'])) echo $multi_dest_stored_meta['sections-3-multidest-textarea'][0]; ?></textarea>

                         </p>
                         <p> <!-- ==== SECTION #3 READ MORE ==== -->

                          <strong><label for="sections-3-multidest-readmore"
                                         class="sections-3-multidest-readmore"><?php _e('<strong>Section &#35;3 Mult-Destination Read More</strong>', 'the-fly-shop') ?></label></strong>

                          <textarea style="width: 100%;" rows="4" name="sections-3-multidest-readmore"
                                    id="sections-3-multidest-readmore"><?php if (isset ($multi_dest_stored_meta['sections-3-multidest-readmore'])) echo $multi_dest_stored_meta['sections-3-multidest-readmore'][0]; ?></textarea>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage2">
                         ...
                         <div class="sections-2-option">
                             <label for="sections-2-option">
                                 <input type="checkbox" name="sections-2-option-checkbox" id="sections-2-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-2-option-checkbox'])) checked($multi_dest_stored_meta['sections-2-option-checkbox'][0], 'yes'); ?> />
                         ...
                         <p> <!-- ==== SECTION #2 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-2-title" id="sections-2-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-2-title'])) echo $multi_dest_stored_meta['sections-2-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #2 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-2-textarea"
                                       id="sections-2-textarea"><?php if (isset ($multi_dest_stored_meta['sections-2-textarea'])) echo $multi_dest_stored_meta['sections-2-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-2-readmore">
                             <label for="sections-2-readmore">
                                 <input type="checkbox" name="sections-2-readmore-checkbox" id="sections-2-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-2-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-2-readmore-checkbox'][0], 'yes'); ?> />
                         ...
                         <p> <!-- ==== SECTION #2 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-2-readmore"
                                       id="sections-2-readmore"><?php if (isset ($multi_dest_stored_meta['sections-2-readmore'])) echo $multi_dest_stored_meta['sections-2-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-2-video-image">
                             <label for="sections-2-video-image">
                                 <input type="checkbox" name="sections-2-video-image-checkbox" id="sections-2-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-2-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-2-video-image-checkbox'][0], 'yes'); ?> />
                         ...
                         <p> <!-- ==== SECTION #2 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-2-image" id="sections-2-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-2-image'])) echo $multi_dest_stored_meta['sections-2-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #2 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-2-video" id="sections-2-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-2-video'])) echo $multi_dest_stored_meta['sections-2-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage3">
                         ...
                         <div class="sections-3-option">
                             <label for="sections-3-option">
                                 <input type="checkbox" name="sections-3-option-checkbox" id="sections-3-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-3-option-checkbox'])) checked($multi_dest_stored_meta['sections-3-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #3 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-3-title" id="sections-3-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-3-title'])) echo $multi_dest_stored_meta['sections-3-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #3 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-3-textarea"
                                       id="sections-3-textarea"><?php if (isset ($multi_dest_stored_meta['sections-3-textarea'])) echo $multi_dest_stored_meta['sections-3-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-3-readmore">
                             <label for="sections-3-readmore">
                                 <input type="checkbox" name="sections-3-readmore-checkbox" id="sections-3-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-3-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-3-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #3 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-3-readmore"
                                       id="sections-3-readmore"><?php if (isset ($multi_dest_stored_meta['sections-3-readmore'])) echo $multi_dest_stored_meta['sections-3-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-3-video-image">
                             <label for="sections-3-video-image">
                                 <input type="checkbox" name="sections-3-video-image-checkbox" id="sections-3-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-3-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-3-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #3 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-3-image" id="sections-3-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-3-image'])) echo $multi_dest_stored_meta['sections-3-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #3 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-3-video" id="sections-3-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-3-video'])) echo $multi_dest_stored_meta['sections-3-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage4">
                         ...
                         <div class="sections-4-option">
                             <label for="sections-4-option">
                                 <input type="checkbox" name="sections-4-option-checkbox" id="sections-4-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-4-option-checkbox'])) checked($multi_dest_stored_meta['sections-4-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #4 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-4-title" id="sections-4-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-4-title'])) echo $multi_dest_stored_meta['sections-4-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #4 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-4-textarea"
                                       id="sections-4-textarea"><?php if (isset ($multi_dest_stored_meta['sections-4-textarea'])) echo $multi_dest_stored_meta['sections-4-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-4-readmore">
                             <label for="sections-4-readmore">
                                 <input type="checkbox" name="sections-4-readmore-checkbox" id="sections-4-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-4-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-4-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #4 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-4-readmore"
                                       id="sections-4-readmore"><?php if (isset ($multi_dest_stored_meta['sections-4-readmore'])) echo $multi_dest_stored_meta['sections-4-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-4-video-image">
                             <label for="sections-4-video-image">
                                 <input type="checkbox" name="sections-4-video-image-checkbox" id="sections-4-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-4-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-4-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #4 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-4-image" id="sections-4-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-4-image'])) echo $multi_dest_stored_meta['sections-4-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #4 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-4-video" id="sections-4-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-4-video'])) echo $multi_dest_stored_meta['sections-4-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage5">
                         ...
                         <div class="sections-5-option">
                             <label for="sections-5-option">
                                 <input type="checkbox" name="sections-5-option-checkbox" id="sections-5-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-5-option-checkbox'])) checked($multi_dest_stored_meta['sections-5-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #5 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-5-title" id="sections-5-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-5-title'])) echo $multi_dest_stored_meta['sections-5-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #5 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-5-textarea"
                                       id="sections-5-textarea"><?php if (isset ($multi_dest_stored_meta['sections-5-textarea'])) echo $multi_dest_stored_meta['sections-5-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-5-readmore">
                             <label for="sections-5-readmore">
                                 <input type="checkbox" name="sections-5-readmore-checkbox" id="sections-5-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-5-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-5-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #5 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-5-readmore"
                                       id="sections-5-readmore"><?php if (isset ($multi_dest_stored_meta['sections-5-readmore'])) echo $multi_dest_stored_meta['sections-5-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-5-video-image">
                             <label for="sections-5-video-image">
                                 <input type="checkbox" name="sections-5-video-image-checkbox" id="sections-5-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-5-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-5-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #5 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-5-image" id="sections-5-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-5-image'])) echo $multi_dest_stored_meta['sections-5-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #5 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-5-video" id="sections-5-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-5-video'])) echo $multi_dest_stored_meta['sections-5-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage6">
                         ...
                         <div class="sections-6-option">
                             <label for="sections-6-option">
                                 <input type="checkbox" name="sections-6-option-checkbox" id="sections-6-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-6-option-checkbox'])) checked($multi_dest_stored_meta['sections-6-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #6 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-6-title" id="sections-6-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-6-title'])) echo $multi_dest_stored_meta['sections-6-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #6 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-6-textarea"
                                       id="sections-6-textarea"><?php if (isset ($multi_dest_stored_meta['sections-6-textarea'])) echo $multi_dest_stored_meta['sections-6-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-6-readmore">
                             <label for="sections-6-readmore">
                                 <input type="checkbox" name="sections-6-readmore-checkbox" id="sections-6-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-6-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-6-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #6 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-6-readmore"
                                       id="sections-6-readmore"><?php if (isset ($multi_dest_stored_meta['sections-6-readmore'])) echo $multi_dest_stored_meta['sections-6-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-6-video-image">
                             <label for="sections-6-video-image">
                                 <input type="checkbox" name="sections-6-video-image-checkbox" id="sections-6-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-6-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-6-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #6 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-6-image" id="sections-6-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-6-image'])) echo $multi_dest_stored_meta['sections-6-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #6 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-6-video" id="sections-6-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-6-video'])) echo $multi_dest_stored_meta['sections-6-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage7">
                         ...
                         <div class="sections-7-option">
                             <label for="sections-7-option">
                                 <input type="checkbox" name="sections-7-option-checkbox" id="sections-7-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-7-option-checkbox'])) checked($multi_dest_stored_meta['sections-7-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #7 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-7-title" id="sections-7-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-7-title'])) echo $multi_dest_stored_meta['sections-7-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #7 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-7-textarea"
                                       id="sections-7-textarea"><?php if (isset ($multi_dest_stored_meta['sections-7-textarea'])) echo $multi_dest_stored_meta['sections-7-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-7-readmore">
                             <label for="sections-7-readmore">
                                 <input type="checkbox" name="sections-7-readmore-checkbox" id="sections-7-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-7-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-7-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #7 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-7-readmore"
                                       id="sections-7-readmore"><?php if (isset ($multi_dest_stored_meta['sections-7-readmore'])) echo $multi_dest_stored_meta['sections-7-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-7-video-image">
                             <label for="sections-7-video-image">
                                 <input type="checkbox" name="sections-7-video-image-checkbox" id="sections-7-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-7-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-7-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #7 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-7-image" id="sections-7-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-7-image'])) echo $multi_dest_stored_meta['sections-7-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #7 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-7-video" id="sections-7-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-7-video'])) echo $multi_dest_stored_meta['sections-7-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage8">
                         ...
                         <div class="sections-8-option">
                             <label for="sections-8-option">
                                 <input type="checkbox" name="sections-8-option-checkbox" id="sections-8-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-8-option-checkbox'])) checked($multi_dest_stored_meta['sections-8-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #8 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-8-title" id="sections-8-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-8-title'])) echo $multi_dest_stored_meta['sections-8-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #8 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-8-textarea"
                                       id="sections-8-textarea"><?php if (isset ($multi_dest_stored_meta['sections-8-textarea'])) echo $multi_dest_stored_meta['sections-8-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-8-readmore">
                             <label for="sections-8-readmore">
                                 <input type="checkbox" name="sections-8-readmore-checkbox" id="sections-8-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-8-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-8-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #8 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-8-readmore"
                                       id="sections-8-readmore"><?php if (isset ($multi_dest_stored_meta['sections-8-readmore'])) echo $multi_dest_stored_meta['sections-8-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-8-video-image">
                             <label for="sections-8-video-image">
                                 <input type="checkbox" name="sections-8-video-image-checkbox" id="sections-8-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-8-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-8-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #8 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-8-image" id="sections-8-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-8-image'])) echo $multi_dest_stored_meta['sections-8-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #8 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-8-video" id="sections-8-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-5-video'])) echo $multi_dest_stored_meta['sections-8-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage9">
                         ...
                         <div class="sections-9-option">
                             <label for="sections-9-option">
                                 <input type="checkbox" name="sections-9-option-checkbox" id="sections-9-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-9-option-checkbox'])) checked($multi_dest_stored_meta['sections-9-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #9 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-9-title" id="sections-9-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-9-title'])) echo $multi_dest_stored_meta['sections-9-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #9 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-9-textarea"
                                       id="sections-9-textarea"><?php if (isset ($multi_dest_stored_meta['sections-9-textarea'])) echo $multi_dest_stored_meta['sections-9-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-9-readmore">
                             <label for="sections-9-readmore">
                                 <input type="checkbox" name="sections-9-readmore-checkbox" id="sections-9-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-9-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-9-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #9 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-9-readmore"
                                       id="sections-9-readmore"><?php if (isset ($multi_dest_stored_meta['sections-9-readmore'])) echo $multi_dest_stored_meta['sections-9-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-9-video-image">
                             <label for="sections-9-video-image">
                                 <input type="checkbox" name="sections-9-video-image-checkbox" id="sections-9-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-9-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-9-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #9 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-9-image" id="sections-9-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-9-image'])) echo $multi_dest_stored_meta['sections-9-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #9 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-9-video" id="sections-9-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-9-video'])) echo $multi_dest_stored_meta['sections-9-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="sectionsimage10">
                         ...
                         <div class="sections-10-option">
                             <label for="sections-10-option">
                                 <input type="checkbox" name="sections-10-option-checkbox" id="sections-10-option-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-10-option-checkbox'])) checked($multi_dest_stored_meta['sections-10-option-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate this section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #10 TITLE ==== -->
                             ...
                             <input style="width:50%;" type="text" name="sections-10-title" id="sections-10-title"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-10-title'])) echo $multi_dest_stored_meta['sections-10-title'][0]; ?>"/>
                         ...
                         <p> <!-- ==== SECTION #10 TEXT AREA ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-10-textarea"
                                       id="sections-10-textarea"><?php if (isset ($multi_dest_stored_meta['sections-10-textarea'])) echo $multi_dest_stored_meta['sections-10-textarea'][0]; ?></textarea>
                         ...
                         <div class="sections-10-readmore">
                             <label for="sections-10-readmore">
                                 <input type="checkbox" name="sections-10-readmore-checkbox" id="sections-10-readmore-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-10-readmore-checkbox'])) checked($multi_dest_stored_meta['sections-10-readmore-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box to activate read more section.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #10 READ MORE ==== -->
                             ...
                             <textarea style="width: 100%;" rows="4" name="sections-10-readmore"
                                       id="sections-10-readmore"><?php if (isset ($multi_dest_stored_meta['sections-10-readmore'])) echo $multi_dest_stored_meta['sections-10-readmore'][0]; ?></textarea>
                         ...
                         <div class="sections-10-video-image">
                             <label for="sections-10-video-image">
                                 <input type="checkbox" name="sections-10-video-image-checkbox" id="sections-10-video-image-checkbox"
                                        value="yes" <?php if (isset ($multi_dest_stored_meta['sections-10-video-image-checkbox'])) checked($multi_dest_stored_meta['sections-10-video-image-checkbox'][0], 'yes'); ?> />
															<?php _e('Check box if you are importing video. Leave unchecked for image.', 'the-fly-shop') ?>
                             </label>
                         </div>
                         ...
                         <p> <!-- ==== SECTION #10 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="sections-10-image" id="sections-10-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-10-image'])) echo $multi_dest_stored_meta['sections-10-image'][0]; ?>"/><br><br>
                         ...
                         <p> <!-- ==== SECTION #10 VIDEO ==== -->
                             ...
                             <input type="url" style="width:50%;" name="sections-10-video" id="sections-10-video"
                                    value="<?php if (isset ($multi_dest_stored_meta['sections-10-video'])) echo $multi_dest_stored_meta['sections-10-video'][0]; ?>"/>
                     ...
                     <div role="tabpanel" class="tab-pane fade in active" id="galleryphoto1">
                         ...
                         <p> <!-- ==== SECTION #1 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-1-image" id="galleryphoto-1-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-1-image'])) echo $multi_dest_stored_meta['galleryphoto-1-image'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="galleryphoto2">
                         ...
                         <p> <!-- ==== SECTION #2 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-2-image" id="galleryphoto-2-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-2-image'])) echo $multi_dest_stored_meta['galleryphoto-2-image'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="galleryphoto3">
                         ...
                         <p> <!-- ==== SECTION #3 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-3-image" id="galleryphoto-3-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-3-image'])) echo $multi_dest_stored_meta['galleryphoto-3-image'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="galleryphoto4">
                         ...
                         <p> <!-- ==== SECTION #4 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-4-image" id="galleryphoto-4-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-4-image'])) echo $multi_dest_stored_meta['galleryphoto-4-image'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="galleryphoto5">
                         ...
                         <p> <!-- ==== SECTION #5 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-5-image" id="galleryphoto-5-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-5-image'])) echo $multi_dest_stored_meta['galleryphoto-5-image'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="galleryphoto6">
                         ...
                         <p> <!-- ==== SECTION #6 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-6-image" id="galleryphoto-6-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-6-image'])) echo $multi_dest_stored_meta['galleryphoto-6-image'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="galleryphoto7">
                         ...
                         <p> <!-- ==== SECTION #7 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-7-image" id="galleryphoto-7-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-7-image'])) echo $multi_dest_stored_meta['galleryphoto-7-image'][0]; ?>"/><br><br>
                     ...
                     <div role="tabpanel" class="tab-pane fade in" id="galleryphoto8">
                         ...
                         <p> <!-- ==== SECTION #8 IMAGE ==== -->
                             ...
                             <input type="text" style="width: 75%;" name="galleryphoto-8-image" id="galleryphoto-8-image"
                                    value="<?php if (isset ($multi_dest_stored_meta['galleryphoto-8-image'])) echo $multi_dest_stored_meta['galleryphoto-8-image'][0]; ?>"/><br><br>
