...
function signature_travel_meta() { global $post;
  ...
  if(!empty($post)) {
    ...
    foreach ($types as $type) {
      if($pageTemplate == 'page-templates/travel-template.php' || $pageTemplate == 'page-templates/signature-template.php' || $pageTemplate == 'page-templates/signature-destinations-template.php') {
