...
add_action('save_post', 'sbm_fish_camp_v3_save');
function sbm_fish_camp_v3_save($post_id)
{

  // Checks save status
  $is_autosave = wp_is_post_autosave($post_id);
  $is_revision = wp_is_post_revision($post_id);
  $is_valid_nonce = (isset($_POST['fish_camp_v3_nonce']) && wp_verify_nonce($_POST['fish_camp_v3_nonce'], basename(__FILE__))) ? 'true' : 'false';
