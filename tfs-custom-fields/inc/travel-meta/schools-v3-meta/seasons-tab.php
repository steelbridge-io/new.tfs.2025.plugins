      ...
      <div class="season-range-controls" style="margin: 20px 0;">
        ...
        <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
         <div>
          ...
          <select name="season1-start-month-2" id="season1-start-month-2" style="width: 130px;">
           <option value="0">Not Set</option>
           <?php
           $selected_start2 = isset($sbm_stored_schoolv3_meta['season1-start-month-2']) ? $sbm_stored_schoolv3_meta['season1-start-month-2'][0] : '';
           foreach($months as $num => $name) {
         ...
         <div>
          ...
          <select name="season1-end-month-2" id="season1-end-month-2" style="width: 130px;">
           <option value="0">Not Set</option>
           <?php
           $selected_end2 = isset($sbm_stored_schoolv3_meta['season1-end-month-2']) ? $sbm_stored_schoolv3_meta['season1-end-month-2'][0] : '';
           foreach($months as $num => $name) {
        ...
        <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
         <div>
          ...
          <select name="season2-start-month-2" id="season2-start-month-2" style="width: 130px;">
           <option value="0">Not Set</option>
           <?php
           $selected_start2 = isset($sbm_stored_schoolv3_meta['season2-start-month-2']) ? $sbm_stored_schoolv3_meta['season2-start-month-2'][0] : '';
           foreach($months as $num => $name) {
            $selected = ($selected_start2 == $num) ? 'selected' : '';
            echo "<option value='$num' $selected>$name</option>";
           }
         ...
         <div>
          ...
          <select name="season2-end-month-2" id="season2-end-month-2" style="width: 130px;">
           <option value="0">Not Set</option>
           <?php
           $selected_end2 = isset($sbm_stored_schoolv3_meta['season2-end-month-2']) ? $sbm_stored_schoolv3_meta['season2-end-month-2'][0] : '';
           foreach($months as $num => $name) {
            $selected = ($selected_end2 == $num) ? 'selected' : '';
            echo "<option value='$num' $selected>$name</option>";
           }
         ...
         <div>
          ...
          <input type="color" name="season2-color-2" id="season2-color-2" value="<?php echo esc_attr(get_post_meta($post->ID, 'season2-color-2', true) ?: '#ffc107'); ?>" style="width: 60px; height: 30px;">
         </div>
        </div>
       ...
       <div class="season-group" style="border: 1px solid #ddd; padding: 15px; margin-bottom: 20px; background: #f9f9f9;">
        ...
        <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
         <div>
          ...
          <select name="season3-start-month-2" id="season3-start-month-2" style="width: 130px;">
           <option value="0">Not Set</option>
           <?php
           $selected_start2 = isset($sbm_stored_schoolv3_meta['season3-start-month-2']) ? $sbm_stored_schoolv3_meta['season3-start-month-2'][0] : '';
           foreach($months as $num => $name) {
            $selected = ($selected_start2 == $num) ? 'selected' : '';
            echo "<option value='$num' $selected>$name</option>";
           }
         ...
         <div>
          ...
          <select name="season3-end-month-2" id="season3-end-month-2" style="width: 130px;">
           <option value="0">Not Set</option>
           <?php
           $selected_end2 = isset($sbm_stored_schoolv3_meta['season3-end-month-2']) ? $sbm_stored_schoolv3_meta['season3-end-month-2'][0] : '';
           foreach($months as $num => $name) {
            $selected = ($selected_end2 == $num) ? 'selected' : '';
            echo "<option value='$num' $selected>$name</option>";
           }
        ...
        <div>
         ...
         <input type="text" name="season3-name-2" id="season3-name-2" value="<?php echo esc_attr(get_post_meta($post->ID, 'season3-name-2', true)); ?>" style="width: 260px;" placeholder="e.g., Late Season (Winter)">
        </div>
       </div>
       ...
       <div class="season-preview" style="margin-top: 20px;">
        ...
        <div class="preview-legend" style="margin-top: 15px; display: flex; gap: 20px; flex-wrap: wrap;">
         ...
         <!-- Range 2 legend entries (hidden unless name-2 provided) -->
      ...
      <script>
          document.addEventListener('DOMContentLoaded', function() {
              ...
              function updateMultiSeasonPreview() {
                  ...
                  // Update legend for primary seasons
                  ...
                  // Update legend for Range 2 entries (show only when name-2 provided)
                  ...
                  // Apply season colors for each month/period with overlap support
                  for (let month = 1; month <= 12; month++) {
                      ...
                      // Set backgrounds per period
                      const periods = ['early', 'mid', 'late'];
                      periods.forEach(period => {
                          const cell = monthEl.querySelector(`.period-${period}`);
                          const contributors = periodsAcc[period];
                          if (!cell) return;
                          if (contributors.length === 1) {
                              cell.style.background = contributors[0];
              ...
              // Add event listeners for all season controls including Range 2
              const inputSelectors = [
                  '#season1-start-month', '#season1-end-month', '#season1-start-part', '#season1-end-part', '#season1-color', '#season1-name',
                  '#season1-start-month-2', '#season1-end-month-2', '#season1-start-part-2', '#season1-end-part-2', '#season1-color-2', '#season1-name-2',
                  '#season2-start-month', '#season2-end-month', '#season2-start-part', '#season2-end-part', '#season2-color', '#season2-name',
                  '#season2-start-month-2', '#season2-end-month-2', '#season2-start-part-2', '#season2-end-part-2', '#season2-color-2', '#season2-name-2',
                  '#season3-start-month', '#season3-end-month', '#season3-start-part', '#season3-end-part', '#season3-color', '#season3-name',
                  '#season3-start-month-2', '#season3-end-month-2', '#season3-start-part-2', '#season3-end-part-2', '#season3-color-2', '#season3-name-2'
              ];
              inputSelectors.forEach(sel => {
                  const el = document.querySelector(sel);
                  if (el) el.addEventListener('change', updateMultiSeasonPreview);
              });
