    ...
    */
    ...
    global $post;
        if(!empty($post)){
            ...
            if( $pageTemplate == 'page-templates/fish-camp-template-v3.php' ) {
                $types = array( 'fishcamp_cpt' );
                foreach($types as $type) {
                    add_meta_box( 'fish_camp_v3_meta', __( 'Fish Camp Content Fields', 'tfs-travel-textdomain' ), 'tfs_fish_camp_v3_meta_callback',
                        $type, 'normal', 'high' );
                }
            }
        }
    }
    add_action( 'add_meta_boxes', 'tfs_custom_fish_camp_v3_meta' );

    // Outputs the content of the meta box
    function tfs_fish_camp_v3_meta_callback( $post ) {
    wp_nonce_field( basename( __FILE__ ), 'fish_camp_v3_nonce' );
    $sbm_stored_fishcampv3_meta = get_post_meta( $post->ID );
    ...
    <strong><label for="travel-logo" class="sbm-row-title"><?php _e( 'Fish Camp Logo', 'the-fly-shop' );?></label></strong><br>
    <input style="width:60%;" type="text" name="dest-travel-logo" id="dest-travel-logo" value="<?php if ( isset (
          $sbm_stored_fishcampv3_meta['dest-travel-logo'] ) ) echo $sbm_stored_fishcampv3_meta['dest-travel-logo'][0];?>" />
    ...
    <div id="dest-travel-logo-preview" style="margin-top: 10px;">
        <?php if ( isset( $sbm_stored_fishcampv3_meta['dest-travel-logo'] ) && $sbm_stored_fishcampv3_meta['dest-travel-logo'][0] != '' ) : ?>
            <img src="<?php echo esc_url( $sbm_stored_fishcampv3_meta['dest-travel-logo'][0] ); ?>"
    ...
    <div class="meta-field-container">
     ...
     <input
      ...
      value="<?php
      if ( isset( $sbm_stored_fishcampv3_meta['travel-hero-video'] ) ) {
       echo esc_attr( $sbm_stored_fishcampv3_meta['travel-hero-video'][0] );
      }
      ?>"
     />
     ...
     <!-- Video Preview -->
     <?php
     $hero_video_current = isset( $sbm_stored_fishcampv3_meta['travel-hero-video'] )
      ? trim( (string) $sbm_stored_fishcampv3_meta['travel-hero-video'][0] )
      : '';
    ...
    <!-- Fish Camp Costs Image -->
    <div class="meta-field-container">

        <strong><label for="travel-costs-image" class="sbm-row-title"><?php _e( 'Fish Camp Costs Image', 'the-fly-shop' );?></label></strong><br>
        <input style="width:75%;" type="text" name="travel-costs-image" id="travel-costs-image" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['travel-costs-image'] ) ) echo $sbm_stored_fishcampv3_meta['travel-costs-image'][0];?>" />
        ...
        <div id="travel-costs-image-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_fishcampv3_meta['travel-costs-image'] ) && $sbm_stored_fishcampv3_meta['travel-costs-image'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_fishcampv3_meta['travel-costs-image'][0] ); ?>"
    ...
    <!-- Fish Camp Costs & Inclusions Video -->
    <div class="meta-field-container">
        <strong><label for="feature_1_video_url" class="sbm-row-title"><?php _e( 'Fish Camp Costs & Inclusions Video URL', 'tfs-travel-textdomain' ); ?></label></strong>
        <input
                type="url"
                ...
                value="<?php
                if ( isset( $sbm_stored_fishcampv3_meta['feature_1_video_url'] ) ) {
                    echo esc_attr( $sbm_stored_fishcampv3_meta['feature_1_video_url'][0] );
                }
                ?>"
        />
        <p class="description"><?php _e( 'Add a direct video URL (e.g., MP4). Playback is user-initiated via controls. Poster uses the Fish Camp Costs image if set.', 'tfs-travel-textdomain' ); ?></p>
    </div>

        <?php
        $feature_1_video_current = isset( $sbm_stored_fishcampv3_meta['feature_1_video_url'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['feature_1_video_url'][0] )
                : '';
        $travel_costs_poster = isset( $sbm_stored_fishcampv3_meta['travel-costs-image'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['travel-costs-image'][0] )
                : '';
        ?>
    ...
    <p><!-- Costs Title -->
        ...
        <input style="width: 100%;" type="text" name="feature-1-title" id="feature-1-title" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-1-title'] ) ) echo $sbm_stored_fishcampv3_meta['feature-1-title'][0]; ?>" />
    </p>
     ...
     <p class="description">Configure a dynamic table to display lodging costs, occupancy rates, seasonal pricing, etc. This table will appear in the Inclusions tab on the frontend.</p>
		 ...
		 $table_config = isset($sbm_stored_fishcampv3_meta['pricing-table-config']) ? json_decode($sbm_stored_fishcampv3_meta['pricing-table-config'][0], true) : array();
		 $table_data = isset($sbm_stored_fishcampv3_meta['pricing-table-data']) ? json_decode($sbm_stored_fishcampv3_meta['pricing-table-data'][0], true) : array();
     ...
     <p><!-- Costs Text Area/Cost-->
        ...
        <textarea style="width: 100%;" rows="4" name="feature-1-cost-textarea" id="feature-1-cost-textarea"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-1-cost-textarea'] ) ) echo $sbm_stored_fishcampv3_meta['feature-1-cost-textarea'][0]; ?></textarea>
    </p>
    ...
    <p><!-- Cost Inclusions Text Area -->
        ...
        <textarea style="width: 100%;" rows="4" name="feature-1-inclusions-textarea" id="feature-1-inclusions-textarea"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-1-inclusions-textarea'] ) ) echo $sbm_stored_fishcampv3_meta['feature-1-inclusions-textarea'][0]; ?></textarea>
    </p>
    ...
    <div class="meta-field-container">
        ...
        <textarea style="width: 100%;" rows="4" name="feature-1-readmore" id="feature-1-readmore"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-1-readmore'] ) ) echo $sbm_stored_fishcampv3_meta['feature-1-readmore'][0]; ?></textarea>
    </div>

    <!-- ====== FEATURE #2 SEASONS ====== -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <h3><?php echo 'Fish Camp Seasons' ?></h3>

    <p><!-- Feature #2 Seasons -->
        <strong><label for="feature-2-seasons-title" class="sbm-row-title"><?php _e( 'Title', 'tfs-travel-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-2-seasons-title" id="feature-2-seasons-title" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-2-seasons-title'] ) ) echo $sbm_stored_fishcampv3_meta['feature-2-seasons-title'][0]; ?>" />
    </p>
    <!-- Feature #2 Image -->
    <div class="meta-field-container">

        <strong><label for="travel-seasons-image" class="sbm-row-title"><?php _e( 'Fish Camp Seasons Image', 'the-fly-shop' );?></label></strong><br>
        <input style="width:75%;" type="text" name="travel-seasons-image" id="travel-seasons-image" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['travel-seasons-image'] ) ) echo $sbm_stored_fishcampv3_meta['travel-seasons-image'][0];?>" />
        ...
        <div id="travel-seasons-image-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_fishcampv3_meta['travel-seasons-image'] ) && $sbm_stored_fishcampv3_meta['travel-seasons-image'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_fishcampv3_meta['travel-seasons-image'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
        ...
        <div class="meta-field-container">
            ...
            <input
                    ...
                    placeholder="https://example.com/path/video.mp4"
                    value="<?php
                    if ( isset( $sbm_stored_fishcampv3_meta['feature_2_video_url'] ) ) {
                        echo esc_attr( $sbm_stored_fishcampv3_meta['feature_2_video_url'][0] );
                    }
                    ?>"
            />
            <p class="description"><?php _e( 'Add a direct video URL (e.g., MP4). Playback is user-initiated via controls. Poster uses the Fish Camp Costs image if set.', 'tfs-travel-textdomain' ); ?></p>
        ...
        <?php
        $feature_2_video_current = isset( $sbm_stored_fishcampv3_meta['feature_2_video_url'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['feature_1_video_url'][0] )
                : '';
        $travel_seasons_poster = isset( $sbm_stored_fishcampv3_meta['travel-seasons-image'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['travel-seasons-image'][0] )
                : '';
        ?>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="basicseason">
                        ...
                        <p><!-- Seasons content/text area -->
                            ...
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-content" id="feature-2-seasons-content"><?php if (isset( $sbm_stored_fishcampv3_meta['feature-2-seasons-content'] ) ) echo $sbm_stored_fishcampv3_meta['feature-2-seasons-content'][0]; ?></textarea>
                        </p>

                        <p><!-- Seasons Read More -->
                            <!-- <strong><label for="feature-2-read-more-info" class="sbm-row-title"><?php //_e( 'Read More Info', 'sbm-textdomain' )?></label></strong>
                            <input style="width: 100%;" type="text" name="feature-2-read-more-info" id="feature-2-read-more-info" placeholder="Add Read More Info" value="<?php //if ( isset ( $sbm_stored_fishcampv3_meta['feature-2-read-more-info'] ) ) echo $sbm_stored_fishcampv3_meta['feature-2-read-more-info'][0]; ?>" /> -->

                            <strong><label for="feature-2-seasons-readmore" class="sbm-row-title"><?php _e( 'Read more', 'tfs-travel-textdomain' )?></label></strong>
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-readmore" id="feature-2-seasons-readmore"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-2-seasons-readmore'] ) ) echo $sbm_stored_fishcampv3_meta['feature-2-seasons-readmore'][0]; ?></textarea>
                        </p>
                    </div> <!-- /tabpanel -->
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="hilowseason">
                        ...
                        <div class="travel-row-content">
                            <label for="high-low-checkbox">
                                <input type="checkbox" name="high-low-checkbox" id="high-low-checkbox" value="yes" <?php if ( isset ( $sbm_stored_fishcampv3_meta['high-low-checkbox'] ) ) checked( $sbm_stored_fishcampv3_meta['high-low-checkbox'][0], 'yes' ); ?> />
                        ...
                        <p><!-- Seasons hi/lo content/text area -->
                            ...
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-hi-lo-content" id="feature-2-seasons-hi-lo-content"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-2-seasons-hi-lo-content'] ) ) echo $sbm_stored_fishcampv3_meta['feature-2-seasons-hi-lo-content'][0]; ?></textarea>
                        </p>
                        ...
                        <p><!-- Seasons High Season -->
                            ...
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-hiseason" id="feature-2-seasons-hiseason"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-2-seasons-hiseason'] ) ) echo $sbm_stored_fishcampv3_meta['feature-2-seasons-hiseason'][0]; ?></textarea>
                        </p>
                        ...
                        <p><!-- Seasons Low Season -->
                            ...
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-lowseason" id="feature-2-seasons-lowseason"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-2-seasons-lowseason'] ) ) echo $sbm_stored_fishcampv3_meta['feature-2-seasons-lowseason'][0]; ?></textarea>
                        </p>
                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="monthlyrange">
                        <div class="meta-field-container">
                            ...
                            <input style="width: 100%;" type="text" name="multi-season-calendar-title" id="multi-season-calendar-title" value="<?php if ( isset ($sbm_stored_fishcampv3_meta['multi-season-calendar-title'] ) ) echo $sbm_stored_fishcampv3_meta['multi-season-calendar-title'][0]; ?>" />
                        </div>
                        ...
                        <div class="travel-row-content">
                            <label for="monthly-range-checkbox">
                                <input type="checkbox" name="monthly-range-checkbox" id="monthly-range-checkbox" value="yes" <?php if ( isset ( $sbm_stored_fishcampv3_meta['monthly-range-checkbox'] ) ) checked( $sbm_stored_fishcampv3_meta['monthly-range-checkbox'][0], 'yes' ); ?> />
                                ...
                                <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
                                    <div>
                                        ...
                                        <select name="season1-start-month" id="season1-start-month" style="width: 130px;">
                                            ...
                                            $selected_start = isset($sbm_stored_fishcampv3_meta['season1-start-month']) ? $sbm_stored_fishcampv3_meta['season1-start-month'][0] : '';
                                    ...
                                    <div>
                                        ...
                                        <select name="season1-end-month" id="season1-end-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_end = isset($sbm_stored_fishcampv3_meta['season1-end-month']) ? $sbm_stored_fishcampv3_meta['season1-end-month'][0] : '';
                                            foreach($months as $num => $name) {
                                ...
                                <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
                                    <div>
                                        ...
                                        <select name="season2-start-month" id="season2-start-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_start = isset($sbm_stored_fishcampv3_meta['season2-start-month']) ? $sbm_stored_fishcampv3_meta['season2-start-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_start == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
                                    ...
                                    <div>
                                        ...
                                        <select name="season2-end-month" id="season2-end-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_end = isset($sbm_stored_fishcampv3_meta['season2-end-month']) ? $sbm_stored_fishcampv3_meta['season2-end-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_end == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
                                ...
                                <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
                                    <div>
                                        ...
                                        <select name="season3-start-month" id="season3-start-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_start = isset($sbm_stored_fishcampv3_meta['season3-start-month']) ? $sbm_stored_fishcampv3_meta['season3-start-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_start == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
                                    ...
                                    <div>
                                        ...
                                        <select name="season3-end-month" id="season3-end-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_end = isset($sbm_stored_fishcampv3_meta['season3-end-month']) ? $sbm_stored_fishcampv3_meta['season3-end-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_end == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
    ...
    <!-- ====== GETTING TO ====== -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <h3><?php echo 'Getting To Fish Camp' ?></h3>

    <!-- Getting To Title -->
    <p>
        <strong><label for="feature-3-get-to-title" class="sbm-row-title"><?php _e( 'Title', 'tfs-travel-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-3-get-to-title" id="feature-3-get-to-title" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-3-get-to-title'] ) ) echo $sbm_stored_fishcampv3_meta['feature-3-get-to-title'][0]; ?>" />
    </p>

    <!-- Getting To Image -->
    <div class="meta-field-container">

        <strong><label for="feature-3-getting-to-image" class="sbm-row-title"><?php _e( 'Getting To Fish Camp Image','the-fly-shop' );?></label></strong><br>
        <input style="width:75%;" type="text" name="feature-3-getting-to-image" id="feature-3-getting-to-image" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-3-getting-to-image'] ) ) echo $sbm_stored_fishcampv3_meta['feature-3-getting-to-image'][0];?>" />
        ...
        <div id="feature-3-getting-to-image-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_fishcampv3_meta['feature-3-getting-to-image'] ) && $sbm_stored_fishcampv3_meta['feature-3-getting-to-image'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_fishcampv3_meta['feature-3-getting-to-image'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
    ...
    <div class="meta-field-container">
        ...
        <input
                ...
                placeholder="https://example.com/path/video.mp4"
                value="<?php
                if ( isset( $sbm_stored_fishcampv3_meta['feature_3_video_url'] ) ) {
                    echo esc_attr( $sbm_stored_fishcampv3_meta['feature_3_video_url'][0] );
                }
                ?>"
        />
        <p class="description"><?php _e( 'Add a direct video URL (e.g., MP4). Playback is user-initiated via controls. Poster uses the Fish Camp Costs image if set.', 'tfs-travel-textdomain' ); ?></p>
        ...
        <?php
        $feature_3_video_current = isset( $sbm_stored_fishcampv3_meta['feature_3_video_url'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['feature_3_video_url'][0] )
                : '';
        $travel_getto_poster = isset( $sbm_stored_fishcampv3_meta['travel-getto-image'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['travel-getto-image'][0] )
                : '';
        ?>
    ...
    <p><!-- Getting To Content/Text Area -->
        ...
        <textarea style="width: 100%;" rows="4" name="feature-3-get-to-content" id="feature-3-get-to-content"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-3-get-to-content'] ) ) echo $sbm_stored_fishcampv3_meta['feature-3-get-to-content'][0]; ?></textarea>
    </p>
    ...
    <p><!-- Getting To Read More -->
        ...
        <input style="width: 100%;" type="text" name="feature-3-read-more-info" id="feature-3-read-more-info" placeholder="Add Read More Info" value="<?php //if ( isset ( $sbm_stored_fishcampv3_meta['feature-3-read-more-info'] ) ) echo $sbm_stored_fishcampv3_meta['feature-3-read-more-info'][0]; ?>" /> -->

        <strong><label for="feature-3-get-to-readmore" class="sbm-row-title"><?php _e( 'Read more', 'tfs-travel-textdomain' )?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-3-get-to-readmore" id="feature-3-get-to-readmore"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-3-get-to-readmore'] ) ) echo $sbm_stored_fishcampv3_meta['feature-3-get-to-readmore'][0]; ?></textarea>
    </p>
    ...
    <p><!-- Lodging Title -->
        ...
        <input style="width: 100%;" type="text" name="feature-4-lodging-title" id="feature-4-lodging-title" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-4-lodging-title'] ) ) echo $sbm_stored_fishcampv3_meta['feature-4-lodging-title'][0]; ?>" />
    </p>

    <!-- Lodging Image -->
    <div class="meta-field-container">

        <strong><label for="feature-4-lodging-img" class="sbm-row-title"><?php _e( 'Fish Camp Loding Image','the-fly-shop' );?></label></strong><br>
        <input style="width:75%;" type="text" name="feature-4-lodging-img" id="feature-4-lodging-img" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-4-lodging-img'] ) ) echo $sbm_stored_fishcampv3_meta['feature-4-lodging-img'][0];?>" />
        ...
        <div id="feature-4-lodging-img-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_fishcampv3_meta['feature-4-lodging-img'] ) && $sbm_stored_fishcampv3_meta['feature-4-lodging-img'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_fishcampv3_meta['feature-4-lodging-img'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
    ...
    <div class="meta-field-container">
        ...
        <input
                ...
                placeholder="https://example.com/path/video.mp4"
                value="<?php
                if ( isset( $sbm_stored_fishcampv3_meta['feature_4_video_url'] ) ) {
                    echo esc_attr( $sbm_stored_fishcampv3_meta['feature_4_video_url'][0] );
                }
                ?>"
        />
        <p class="description"><?php _e( 'Add a direct video URL (e.g., MP4). Playback is user-initiated via controls. Poster uses the Fish Camp Costs image if set.', 'tfs-travel-textdomain' ); ?></p>
        ...
        <?php
        $feature_4_video_current = isset( $sbm_stored_fishcampv3_meta['feature_4_video_url'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['feature_4_video_url'][0] )
                : '';
        $travel_lodging_poster = isset( $sbm_stored_fishcampv3_meta['travel-lodging-image'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['travel-lodging-image'][0] )
                : '';
        ?>
    ...
    <p>
        ...
        <textarea style="width: 100%;" rows="4" name="feature-4-lodging-content" id="feature-4-lodging-content"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-4-lodging-content'] ) ) echo $sbm_stored_fishcampv3_meta['feature-4-lodging-content'][0]; ?></textarea>
    </p>

    <p><!-- Lodging Read More -->
        <!-- <strong><label for="feature-4-read-more-info" class="sbm-row-title"><?php //_e( 'Read More Info', 'sbm-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-4-read-more-info" id="feature-4-read-more-info" placeholder="Add Read More Info" value="<?php //if ( isset ( $sbm_stored_fishcampv3_meta['feature-4-read-more-info'] ) ) echo $sbm_stored_fishcampv3_meta['feature-4-read-more-info'][0]; ?>" /> -->

        <strong><label for="feature-4-lodging-readmore" class="sbm-row-title"><?php _e( 'Read more', 'tfs-travel-textdomain' )?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-4-lodging-readmore" id="feature-4-lodging-readmore"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-4-lodging-readmore'] ) ) echo $sbm_stored_fishcampv3_meta['feature-4-lodging-readmore'][0]; ?></textarea>
    </p>

    <!-- ====== ANGLING ====== -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <h3><?php echo 'Fish Camp Angling' ?></h3>

    <p><!-- Angling Title -->
        <strong><label for="feature-5-angling-title" class="sbm-row-title"><?php _e( 'Title', 'tfs-travel-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-5-angling-title" id="feature-5-angling-title" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-5-angling-title'] ) ) echo $sbm_stored_fishcampv3_meta['feature-5-angling-title'][0]; ?>" />
    </p>

    <!-- Angling Image -->
    <div class="meta-field-container">

        <strong><label for="feature-5-angling-img" class="sbm-row-title"><?php _e( 'Fish Camp Angling Image','the-fly-shop' );?></label></strong><br>
        <input style="width:75%;" type="text" name="feature-5-angling-img" id="feature-5-angling-img" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-5-angling-img'] ) ) echo $sbm_stored_fishcampv3_meta['feature-5-angling-img'][0];?>" />
        ...
        <div id="feature-5-angling-img-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_fishcampv3_meta['feature-5-angling-img'] ) && $sbm_stored_fishcampv3_meta['feature-5-angling-img'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_fishcampv3_meta['feature-5-angling-img'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
    ...
    <div class="meta-field-container">
        ...
        <input
                ...
                placeholder="https://example.com/path/video.mp4"
                value="<?php
                if ( isset( $sbm_stored_fishcampv3_meta['feature_5_video_url'] ) ) {
                    echo esc_attr( $sbm_stored_fishcampv3_meta['feature_5_video_url'][0] );
                }
                ?>"
        />
        <p class="description"><?php _e( 'Add a direct video URL (e.g., MP4). Playback is user-initiated via controls. Poster uses the Fish Camp Costs image if set.', 'tfs-travel-textdomain' ); ?></p>
        ...
        <?php
        $feature_5_video_current = isset( $sbm_stored_fishcampv3_meta['feature_5_video_url'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['feature_5_video_url'][0] )
                : '';
        $travel_angling_poster = isset( $sbm_stored_fishcampv3_meta['travel-angling-image'] )
                ? trim( (string) $sbm_stored_fishcampv3_meta['travel-angling-image'][0] )
                : '';
        ?>
    ...
    <p><!-- Angling Content -->
        ...
        <textarea style="width: 100%;" rows="4" name="feature-5-angling-content" id="feature-5-angling-content"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-5-angling-content'] ) ) echo $sbm_stored_fishcampv3_meta['feature-5-angling-content'][0]; ?></textarea>
    </p>

    <p><!-- Fish Camp Angling Read More -->
        <!-- <strong><label for="feature-5-read-more-info" class="sbm-row-title"><?php //_e( 'Read More Info', 'sbm-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-5-read-more-info" id="feature-5-read-more-info" placeholder="Add Read More Info" value="<?php //if ( isset ( $sbm_stored_fishcampv3_meta['feature-5-read-more-info'] ) ) echo $sbm_stored_fishcampv3_meta['feature-5-read-more-info'][0]; ?>" /> -->

        <strong><label for="feature-5-angling-readmore" class="sbm-row-title"><?php _e( 'Read more', 'tfs-travel-textdomain' )?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-5-angling-readmore" id="feature-5-angling-readmore"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-5-angling-readmore'] ) ) echo $sbm_stored_fishcampv3_meta['feature-5-angling-readmore'][0]; ?></textarea>
    </p>
    ...
    <p>
     ...
     <input style="width: 100%;" type="text" name="feature-6-species-title" id="feature-6-species-title" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-6-species-title'] ) ) echo $sbm_stored_fishcampv3_meta['feature-6-species-title'][0]; ?>" />
    </p>
    ...
    <div class="meta-field-container">
     ...
     <input style="width:75%;" type="text" name="feature-6-species-img" id="feature-6-species-img" value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-6-species-img'] ) ) echo $sbm_stored_fishcampv3_meta['feature-6-species-img'][0];?>" />
     ...
     <div id="feature-6-species-img-preview" style="margin-top: 10px;">
      <?php if ( isset( $sbm_stored_fishcampv3_meta['feature-6-species-img'] ) && $sbm_stored_fishcampv3_meta['feature-6-species-img'][0] != '' ) : ?>
       <img src="<?php echo esc_url( $sbm_stored_fishcampv3_meta['feature-6-species-img'][0] ); ?>"
            style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
            alt="Preview" />
    ...
    <div class="meta-field-container">
     ...
     <input
      ...
      placeholder="https://example.com/path/video.mp4"
      value="<?php
      if ( isset( $sbm_stored_fishcampv3_meta['feature_6_video_url'] ) ) {
       echo esc_attr( $sbm_stored_fishcampv3_meta['feature_6_video_url'][0] );
      }
      ?>"
     />
     ...
     <?php
     $feature_6_video_current = isset( $sbm_stored_fishcampv3_meta['feature_6_video_url'] )
      ? trim( (string) $sbm_stored_fishcampv3_meta['feature_6_video_url'][0] )
      : '';
     $species_poster = isset( $sbm_stored_fishcampv3_meta['feature-6-species-img'] )
      ? trim( (string) $sbm_stored_fishcampv3_meta['feature-6-species-img'][0] )
      : '';
     ?>
    ...
    <p><!-- Species Content -->
     ...
     <textarea style="width: 100%;" rows="4" name="feature-6-species-content" id="feature-6-species-content"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-6-species-content'] ) ) echo $sbm_stored_fishcampv3_meta['feature-6-species-content'][0]; ?></textarea>
    </p>
    ...
    <p><!-- Species Read More -->
     ...
     <textarea style="width: 100%;" rows="4" name="feature-6-species-readmore" id="feature-6-species-readmore"><?php if ( isset ( $sbm_stored_fishcampv3_meta['feature-6-species-readmore'] ) ) echo $sbm_stored_fishcampv3_meta['feature-6-species-readmore'][0]; ?></textarea>
    </p>
    ...
    <div class="travel-row-content">
        ...
        <input style="width: 100%;" type="text" name="whywe-title-2" id="whywe-title-2" value="<?php if ( isset (
                $sbm_stored_fishcampv3_meta['whywe-title-2'] ) ) echo $sbm_stored_fishcampv3_meta['whywe-title-2'][0];
        ?>" />
        ...
        <textarea style="width:100%;" rows="10"
                  ...
                  id="whywe-textarea-2"><?php if ( isset ( $sbm_stored_fishcampv3_meta['whywe-textarea-2'] ) ) {
                echo $sbm_stored_fishcampv3_meta['whywe-textarea-2'][0];
            } ?></textarea>
    </div>
    ...
    <p><!-- Get Started Section -->
        ...
        <input style="width: 100%;" type="text" placeholder="Place CTA content here." name="cta-strong-intro" id="cta-strong-intro" value="<?php if (isset($sbm_stored_fishcampv3_meta['cta-strong-intro'])) echo $sbm_stored_fishcampv3_meta['cta-strong-intro'][0]; ?>" />
    </p>
    ...
    <p><!-- Get Started Section Content -->
        ...
        <textarea style="width: 100%;" rows="4" name="cta-content" id="cta-content"><?php if ( isset ( $sbm_stored_fishcampv3_meta['cta-content'] ) ) echo $sbm_stored_fishcampv3_meta['cta-content'][0]; ?></textarea>
    </p>
    ...
    <p> <!-- Additional Image #1 -->
        ...
        <input type="text" name="additional-travel-image1"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image1'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image1'][0];
               } ?>"/>
    ...
    <p> <!-- Additional Image #2 -->
        ...
        <input type="text" name="additional-travel-image2"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image2'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image2'][0];
               } ?>"/>
    ...
    <p> <!-- Additional Image #3 -->
        ...
        <input type="text" name="additional-travel-image3"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image3'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image3'][0];
               } ?>"/>
    ...
    <p> <!-- Additional Image #4 -->
        ...
        <input type="text" name="additional-travel-image4"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image4'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image4'][0];
               } ?>"/>
    ...
    <p> <!-- Additional Image #5 -->
        ...
        <input type="text" name="additional-travel-image5"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image5'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image5'][0];
               } ?>"/>
    ...
    <p> <!-- Additional Image #6 -->
        ...
        <input type="text" name="additional-travel-image6"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image6'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image6'][0];
               } ?>"/>
    ...
    <p> <!-- Additional Image #7 -->
        ...
        <input type="text" name="additional-travel-image7"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image7'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image7'][0];
               } ?>"/>
    ...
    <p> <!-- Additional Image #8 -->
        ...
        <input type="text" name="additional-travel-image8"
               ...
               value="<?php if ( isset ( $sbm_stored_fishcampv3_meta['additional-travel-image8'] ) ) {
                   echo $sbm_stored_fishcampv3_meta['additional-travel-image8'][0];
               } ?>"/>
