    ...
    */
    ...
    <h3><?php echo 'School Costs' ?></h3>

    <!-- School Costs Image -->
    <div class="meta-field-container">

        <strong><label for="schoolv3-costs-image" class="sbm-row-title"><?php _e( 'School Costs Image', 'the-fly-shop' );?></label></strong><br>
        <input style="width:75%;" type="text" name="schoolv3-costs-image" id="schoolv3-costs-image" value="<?php if ( isset ( $sbm_stored_schoolv3_meta['schoolv3-costs-image'] ) ) echo $sbm_stored_schoolv3_meta['schoolv3-costs-image'][0];?>" />
        <input type="button" id="schoolv3-costs-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />

        <!-- Preview container -->
        <div id="schoolv3-costs-image-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_schoolv3_meta['schoolv3-costs-image'] ) && $sbm_stored_schoolv3_meta['schoolv3-costs-image'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_schoolv3_meta['schoolv3-costs-image'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
                <br><button type="button" id="schoolv3-costs-image-remove" class="button" style="margin-top: 5px;">Remove Image</button>
            <?php endif; ?>
        </div>
    </div>

    <!-- School Costs & Inclusions Video -->
    <div class="meta-field-container">
        <strong><label for="feature_1_video_url" class="sbm-row-title"><?php _e( 'School Costs & Inclusions Video URL', 'tfs-schoolv3-textdomain' ); ?></label></strong>
        <input
                type="url"
                ...
                value="<?php
                if ( isset( $sbm_stored_schoolv3_meta['feature_1_video_url'] ) ) {
                    echo esc_attr( $sbm_stored_schoolv3_meta['feature_1_video_url'][0] );
                }
                ?>"
        />
        ...
        <?php
        $feature_1_video_current = isset( $sbm_stored_schoolv3_meta['feature_1_video_url'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['feature_1_video_url'][0] )
                : '';
        $schoolv3_costs_poster = isset( $sbm_stored_schoolv3_meta['schoolv3-costs-image'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['schoolv3-costs-image'][0] )
                : '';
        ?>
        <div id="feature-1-video-preview" style="margin-top:10px; <?php echo $feature_1_video_current ? '' : 'display:none;'; ?>">
            <video
                    ...
                    preload="metadata"
                    style="max-width:24%;height:auto;"
                    <?php if ( $schoolv3_costs_poster ) : ?>
                        poster="<?php echo esc_url( $schoolv3_costs_poster ); ?>"
                    <?php endif; ?>
            >
    ...
    <p><!-- Costs Title -->
        <strong><label for="feature-1-title" class="sbm-row-title"><?php _e( 'Title', 'tfs-schoolv3-textdomain' )?></label></strong>

        <input style="width: 100%;" type="text" name="feature-1-title" id="feature-1-title" value="<?php if ( isset ( $sbm_stored_schoolv3_meta['feature-1-title'] ) ) echo $sbm_stored_schoolv3_meta['feature-1-title'][0]; ?>" />
    </p>
     ...
     <p class="description">Configure a dynamic table to display lodging costs, occupancy rates, seasonal pricing, etc. This table will appear in the Inclusions tab on the frontend.</p>
		 ...
		 $table_config = isset($sbm_stored_schoolv3_meta['pricing-table-config']) ? json_decode($sbm_stored_schoolv3_meta['pricing-table-config'][0], true) : array();
		 $table_data = isset($sbm_stored_schoolv3_meta['pricing-table-data']) ? json_decode($sbm_stored_schoolv3_meta['pricing-table-data'][0], true) : array();
     ...
     <p><!-- Costs Text Area/Cost-->
        <strong><label for="feature-1-cost-textarea" class="sbm-row-title"><?php _e( 'Cost', 'tfs-schoolv3-textdomain' )?></label></strong>

        <textarea style="width: 100%;" rows="4" name="feature-1-cost-textarea" id="feature-1-cost-textarea"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-1-cost-textarea'] ) ) echo $sbm_stored_schoolv3_meta['feature-1-cost-textarea'][0]; ?></textarea>
    </p>

    <p><!-- Cost Inclusions Text Area -->
        <strong><label for="feature-1-inclusions-textarea" class="sbm-row-title"><?php _e( 'Inclusions', 'tfs-schoolv3-textdomain' )?></label></strong>

        <textarea style="width: 100%;" rows="4" name="feature-1-inclusions-textarea" id="feature-1-inclusions-textarea"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-1-inclusions-textarea'] ) ) echo $sbm_stored_schoolv3_meta['feature-1-inclusions-textarea'][0]; ?></textarea>
    </p>

    <p><!-- Cost Non-inclusions Text Area -->
        <strong><label for="feature-1-noninclusions-textarea" class="sbm-row-title"><?php _e( 'Non-inclusions', 'tfs-schoolv3-textdomain' )?></label></strong>

        <textarea style="width: 100%;" rows="4" name="feature-1-noninclusions-textarea" id="feature-1-noninclusions-textarea"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-1-noninclusions-textarea'] ) ) echo $sbm_stored_schoolv3_meta['feature-1-noninclusions-textarea'][0]; ?></textarea>
    </p>

    <p><!-- School Insurance Text Area -->
        <strong><label for="feature-1-schoolv3ins-textarea" class="sbm-row-title"><?php _e( 'School Insurance', 'tfs-schoolv3-textdomain' )?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-1-schoolv3ins-textarea" id="feature-1-schoolv3ins-textarea"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-1-schoolv3ins-textarea'] ) ) echo $sbm_stored_schoolv3_meta['feature-1-schoolv3ins-textarea'][0]; ?></textarea>
    </p>

    <div class="meta-field-container">
        <strong><label for="feature-1-readmore" class="sbm-row-title"><?php _e( 'School costs "Read More" section', 'tfs-schoolv3-textdomain')?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-1-readmore" id="feature-1-readmore"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-1-readmore'] ) ) echo $sbm_stored_schoolv3_meta['feature-1-readmore'][0]; ?></textarea>
    </div>

    <!-- ====== FEATURE #2 SEASONS ====== -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <h3><?php echo 'School Seasons' ?></h3>

    <p><!-- Feature #2 Seasons -->
        <strong><label for="feature-2-seasons-title" class="sbm-row-title"><?php _e( 'Title', 'tfs-schoolv3-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-2-seasons-title" id="feature-2-seasons-title" value="<?php if ( isset ( $sbm_stored_schoolv3_meta['feature-2-seasons-title'] ) ) echo $sbm_stored_schoolv3_meta['feature-2-seasons-title'][0]; ?>" />
    </p>
    <!-- Feature #2 Image -->
    <div class="meta-field-container">

        <strong><label for="schoolv3-seasons-image" class="sbm-row-title"><?php _e( 'School Seasons Image', 'the-fly-shop' ); ?></label></strong><br>
        <input style="width:75%;" type="text" name="schoolv3-seasons-image" id="schoolv3-seasons-image" value="<?php if ( isset ( $sbm_stored_schoolv3_meta['schoolv3-seasons-image'] ) ) echo $sbm_stored_schoolv3_meta['schoolv3-seasons-image'][0]; ?>" />
        <input type="button" id="schoolv3-seasons-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' ); ?>" />

        <!-- Preview container -->
        <div id="schoolv3-seasons-image-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_schoolv3_meta['schoolv3-seasons-image'] ) && $sbm_stored_schoolv3_meta['schoolv3-seasons-image'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_schoolv3_meta['schoolv3-seasons-image'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
                <br><button type="button" id="schoolv3-seasons-image-remove" class="button" style="margin-top: 5px;">Remove Image</button>
            <?php endif; ?>
        </div>
    </div>
        ...
        $feature_2_video_current = isset( $sbm_stored_schoolv3_meta['feature_2_video_url'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['feature_1_video_url'][0] )
                : '';
        $schoolv3_seasons_poster = isset( $sbm_stored_schoolv3_meta['schoolv3-seasons-image'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['schoolv3-seasons-image'][0] )
                : '';
        ?>
        <div id="feature-2-video-preview" style="margin-top:10px; <?php echo $feature_2_video_current ? '' : 'display:none;'; ?>">
            <video
                    ...
                    style="max-width:24%;height:auto;"
                    <?php if ( $schoolv3_costs_poster ) : ?>
                        poster="<?php echo esc_url( $schoolv3_seasons_poster ); ?>"
                    <?php endif; ?>
            >
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="basicseason">
                        ...
                        <p><!-- Seasons content/text area -->
                            <strong><label for="feature-2-seasons-content" class="sbm-row-title"><?php _e( 'Seasons Content', 'tfs-schoolv3-textdomain' )?></label></strong>

                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-content" id="feature-2-seasons-content"><?php if (isset( $sbm_stored_schoolv3_meta['feature-2-seasons-content'] ) ) echo $sbm_stored_schoolv3_meta['feature-2-seasons-content'][0]; ?></textarea>
                        </p>

                        <p><!-- Seasons Read More -->
                            <!-- <strong><label for="feature-2-read-more-info" class="sbm-row-title"><?php //_e( 'Read More Info', 'sbm-textdomain' )?></label></strong>
                            <input style="width: 100%;" type="text" name="feature-2-read-more-info" id="feature-2-read-more-info" placeholder="Add Read More Info" value="<?php //if ( isset ( $sbm_stored_schoolv3_meta['feature-2-read-more-info'] ) ) echo $sbm_stored_schoolv3_meta['feature-2-read-more-info'][0]; ?>" /> -->

                            <strong><label for="feature-2-seasons-readmore" class="sbm-row-title"><?php _e( 'Read more', 'tfs-schoolv3-textdomain' )?></label></strong>
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-readmore" id="feature-2-seasons-readmore"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-2-seasons-readmore'] ) ) echo $sbm_stored_schoolv3_meta['feature-2-seasons-readmore'][0]; ?></textarea>
                        </p>
                    </div> <!-- /tabpanel -->
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="hilowseason">
                        ...
                        <!-- ==== Add Hi/Lo Section ==== -->
                        <span class="schoolv3-row-title"><?php _e( '<strong>Display Hi/Lo Fishing Seasons</strong>', 'tfs-schoolv3-textdomain' )?></span>
                        <div class="schoolv3-row-content">
                            <label for="high-low-checkbox">
                                <input type="checkbox" name="high-low-checkbox" id="high-low-checkbox" value="yes" <?php if ( isset ( $sbm_stored_schoolv3_meta['high-low-checkbox'] ) ) checked( $sbm_stored_schoolv3_meta['high-low-checkbox'][0], 'yes' ); ?> />
                                <?php _e( 'Check box to activate Hi/Lo seasons.', 'tfs-schoolv3-textdomain' )?>
                            </label>
                        </div>

                        <p><!-- Seasons hi/lo content/text area -->
                            <strong><label for="feature-2-seasons-hi-lo-content" class="sbm-row-title"><?php _e( 'Seasons Hi/Lo Content', 'tfs-schoolv3-textdomain' )?></label></strong>
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-hi-lo-content" id="feature-2-seasons-hi-lo-content"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-2-seasons-hi-lo-content'] ) ) echo $sbm_stored_schoolv3_meta['feature-2-seasons-hi-lo-content'][0]; ?></textarea>
                        </p>

                        <p><!-- Seasons High Season -->
                            <strong><label for="feature-2-seasons-hiseason" class="sbm-row-title"><?php _e( 'High Season', 'tfs-schoolv3-textdomain' )?></label></strong>
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-hiseason" id="feature-2-seasons-hiseason"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-2-seasons-hiseason'] ) ) echo $sbm_stored_schoolv3_meta['feature-2-seasons-hiseason'][0]; ?></textarea>
                        </p>

                        <p><!-- Seasons Low Season -->
                            <strong><label for="feature-2-seasons-lowseason" class="sbm-row-title"><?php _e( 'Low Season', 'tfs-schoolv3-textdomain' )?></label></strong>
                            <textarea style="width: 100%;" rows="4" name="feature-2-seasons-lowseason" id="feature-2-seasons-lowseason"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-2-seasons-lowseason'] ) ) echo $sbm_stored_schoolv3_meta['feature-2-seasons-lowseason'][0]; ?></textarea>
                        </p>
                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="monthlyrange">
                        <div class="meta-field-container">
                            <strong><label for="multi-season-calendar-title" class="sbm-row-title"><?php _e( 'Season Calendar Title', 'tfs-schoolv3-textdomain' )?></label></strong>
                            <input style="width: 100%;" type="text" name="multi-season-calendar-title" id="multi-season-calendar-title" value="<?php if ( isset ($sbm_stored_schoolv3_meta['multi-season-calendar-title'] ) ) echo $sbm_stored_schoolv3_meta['multi-season-calendar-title'][0]; ?>" />
                        </div>

                        <p>
                            <span class="schoolv3-row-title"><?php _e( '<strong>Display Monthly Season Range</strong>', 'tfs-schoolv3-textdomain' )?></span>
                        <div class="schoolv3-row-content">
                            <label for="monthly-range-checkbox">
                                <input type="checkbox" name="monthly-range-checkbox" id="monthly-range-checkbox" value="yes" <?php if ( isset ( $sbm_stored_schoolv3_meta['monthly-range-checkbox'] ) ) checked( $sbm_stored_schoolv3_meta['monthly-range-checkbox'][0], 'yes' ); ?> />
                                <?php _e( 'Check box to activate Monthly Range display.', 'tfs-schoolv3-textdomain' )?>
                            </label>
                        </div>
                        </p>
                                ...
                                <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
                                    <div>
                                        ...
                                        <select name="season1-start-month" id="season1-start-month" style="width: 130px;">
                                            ...
                                            $selected_start = isset($sbm_stored_schoolv3_meta['season1-start-month']) ? $sbm_stored_schoolv3_meta['season1-start-month'][0] : '';
                                    ...
                                    <div>
                                        ...
                                        <select name="season1-end-month" id="season1-end-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_end = isset($sbm_stored_schoolv3_meta['season1-end-month']) ? $sbm_stored_schoolv3_meta['season1-end-month'][0] : '';
                                            foreach($months as $num => $name) {
                                ...
                                <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
                                    <div>
                                        ...
                                        <select name="season2-start-month" id="season2-start-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_start = isset($sbm_stored_schoolv3_meta['season2-start-month']) ? $sbm_stored_schoolv3_meta['season2-start-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_start == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
                                    ...
                                    <div>
                                        ...
                                        <select name="season2-end-month" id="season2-end-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_end = isset($sbm_stored_schoolv3_meta['season2-end-month']) ? $sbm_stored_schoolv3_meta['season2-end-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_end == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
                                ...
                                <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
                                    <div>
                                        ...
                                        <select name="season3-start-month" id="season3-start-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_start = isset($sbm_stored_schoolv3_meta['season3-start-month']) ? $sbm_stored_schoolv3_meta['season3-start-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_start == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
                                    ...
                                    <div>
                                        ...
                                        <select name="season3-end-month" id="season3-end-month" style="width: 130px;">
                                            <option value="0">Not Set</option>
                                            <?php
                                            $selected_end = isset($sbm_stored_schoolv3_meta['season3-end-month']) ? $sbm_stored_schoolv3_meta['season3-end-month'][0] : '';
                                            foreach($months as $num => $name) {
                                                $selected = ($selected_end == $num) ? 'selected' : '';
                                                echo "<option value='$num' $selected>$name</option>";
                                            }
    ...
    <!-- Getting To Title -->
    <p>
        <strong><label for="feature-3-get-to-title" class="sbm-row-title"><?php _e( 'Title', 'tfs-schoolv3-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-3-get-to-title" id="feature-3-get-to-title" value="<?php if ( isset ( $sbm_stored_schoolv3_meta['feature-3-get-to-title'] ) ) echo $sbm_stored_schoolv3_meta['feature-3-get-to-title'][0]; ?>" />
    </p>
    ...
    <div class="meta-field-container">
        ...
        <input style="width:75%;" type="text" name="feature-3-getting-to-image" id="feature-3-getting-to-image" value="<?php if ( isset ( $sbm_stored_schoolv3_meta['feature-3-getting-to-image'] ) ) echo $sbm_stored_schoolv3_meta['feature-3-getting-to-image'][0];?>" />
        ...
        <div id="feature-3-getting-to-image-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_schoolv3_meta['feature-3-getting-to-image'] ) && $sbm_stored_schoolv3_meta['feature-3-getting-to-image'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_schoolv3_meta['feature-3-getting-to-image'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
    ...
    <!-- Getting To Video -->
    <div class="meta-field-container">
        <strong><label for="feature_3_video_url" class="sbm-row-title"><?php _e( 'Getting To Video URL', 'tfs-schoolv3-textdomain' ); ?></label></strong>
        <input
                type="url"
                ...
                placeholder="https://example.com/path/video.mp4"
                value="<?php
                if ( isset( $sbm_stored_schoolv3_meta['feature_3_video_url'] ) ) {
                    echo esc_attr( $sbm_stored_schoolv3_meta['feature_3_video_url'][0] );
                }
                ?>"
        />
        <p class="description"><?php _e( 'Add a direct video URL (e.g., MP4). Playback is user-initiated via controls. Poster uses the School Costs image if set.', 'tfs-schoolv3-textdomain' ); ?></p>
        ...
        <?php
        $feature_3_video_current = isset( $sbm_stored_schoolv3_meta['feature_3_video_url'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['feature_3_video_url'][0] )
                : '';
        $schoolv3_getto_poster = isset( $sbm_stored_schoolv3_meta['schoolv3-getto-image'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['schoolv3-getto-image'][0] )
                : '';
        ?>
        <div id="feature-3-video-preview" style="margin-top:10px; <?php echo $feature_3_video_current ? '' : 'display:none;'; ?>">
            <video
                    ...
                    preload="metadata"
                    style="max-width:24%;height:auto;"
                    <?php if ( $schoolv3_getto_poster ) : ?>
                        poster="<?php echo esc_url( $schoolv3_getto_poster ); ?>"
                    <?php endif; ?>
            >
    ...
    <p><!-- Getting To Content/Text Area -->
        <strong><label for="feature-3-get-to-content" class="sbm-row-title"><?php _e( 'Content', 'tfs-schoolv3-textdomain' )?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-3-get-to-content" id="feature-3-get-to-content"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-3-get-to-content'] ) ) echo $sbm_stored_schoolv3_meta['feature-3-get-to-content'][0]; ?></textarea>
    </p>
    ...
    <p><!-- Lodging Title -->
        ...
        <input style="width: 100%;" type="text" name="feature-4-lodging-title" id="feature-4-lodging-title" value="<?php if ( isset ( $sbm_stored_schoolv3_meta['feature-4-lodging-title'] ) ) echo $sbm_stored_schoolv3_meta['feature-4-lodging-title'][0]; ?>" />
    </p>
    ...
    <div class="meta-field-container">
        ...
        <div id="feature-4-lodging-img-preview" style="margin-top: 10px;">
            <?php if ( isset( $sbm_stored_schoolv3_meta['feature-4-lodging-img'] ) && $sbm_stored_schoolv3_meta['feature-4-lodging-img'][0] != '' ) : ?>
                <img src="<?php echo esc_url( $sbm_stored_schoolv3_meta['feature-4-lodging-img'][0] ); ?>"
                     style="max-width: 250px; max-height: 250px; border: 1px solid #ddd; padding: 5px;"
                     alt="Preview" />
    ...
    <!-- Lodging Video -->
    <div class="meta-field-container">
        <strong><label for="feature_4_video_url" class="sbm-row-title"><?php _e( 'Lodging Video URL', 'tfs-schoolv3-textdomain' ); ?></label></strong>
        <input
                type="url"
                ...
                placeholder="https://example.com/path/video.mp4"
                value="<?php
                if ( isset( $sbm_stored_schoolv3_meta['feature_4_video_url'] ) ) {
                    echo esc_attr( $sbm_stored_schoolv3_meta['feature_4_video_url'][0] );
                }
                ?>"
        />
        <p class="description"><?php _e( 'Add a direct video URL (e.g., MP4). Playback is user-initiated via controls. Poster uses the School Costs image if set.', 'tfs-schoolv3-textdomain' ); ?></p>
        ...
        <?php
        $feature_4_video_current = isset( $sbm_stored_schoolv3_meta['feature_4_video_url'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['feature_4_video_url'][0] )
                : '';
        $schoolv3_lodging_poster = isset( $sbm_stored_schoolv3_meta['schoolv3-lodging-image'] )
                ? trim( (string) $sbm_stored_schoolv3_meta['schoolv3-lodging-image'][0] )
                : '';
        ?>
    ...
    <div id="feature-4-video-preview" style="margin-top:10px; <?php echo $feature_4_video_current ? '' : 'display:none;'; ?>">
        <video
                ...
                preload="metadata"
                style="max-width:24%;height:auto;"
                <?php if ( $schoolv3_lodging_poster ) : ?>
                    poster="<?php echo esc_url( $schoolv3_lodging_poster ); ?>"
                <?php endif; ?>
        >
    ...
    <!-- Lodging Content -->
    <p>
        <strong><label for="feature-4-lodging-content" class="sbm-row-title"><?php _e( 'Content', 'tfs-schoolv3-textdomain' )?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-4-lodging-content" id="feature-4-lodging-content"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-4-lodging-content'] ) ) echo $sbm_stored_schoolv3_meta['feature-4-lodging-content'][0]; ?></textarea>
    </p>

    <p><!-- Lodging Read More -->
        <!-- <strong><label for="feature-4-read-more-info" class="sbm-row-title"><?php //_e( 'Read More Info', 'sbm-textdomain' )?></label></strong>
        <input style="width: 100%;" type="text" name="feature-4-read-more-info" id="feature-4-read-more-info" placeholder="Add Read More Info" value="<?php //if ( isset ( $sbm_stored_schoolv3_meta['feature-4-read-more-info'] ) ) echo $sbm_stored_schoolv3_meta['feature-4-read-more-info'][0]; ?>" /> -->

        <strong><label for="feature-4-lodging-readmore" class="sbm-row-title"><?php _e( 'Read more', 'tfs-schoolv3-textdomain' )?></label></strong>
        <textarea style="width: 100%;" rows="4" name="feature-4-lodging-readmore" id="feature-4-lodging-readmore"><?php if ( isset ( $sbm_stored_schoolv3_meta['feature-4-lodging-readmore'] ) ) echo $sbm_stored_schoolv3_meta['feature-4-lodging-readmore'][0]; ?></textarea>
    </p>
