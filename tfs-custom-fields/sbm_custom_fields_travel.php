    ...
    */
    ...
    <?php include(plugin_dir_path(__FILE__) . 'inc/travel-meta/destination-v3-meta/seasons-tab.php'); ?>

    <!-- Getting To Tab -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <?php include (plugin_dir_path(__FILE__) . 'inc/travel-meta/destination-v3-meta/getting-there-tab.php'); ?>

    <!-- Lodging Tab -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <?php include (plugin_dir_path( __FILE__ ) . 'inc/travel-meta/destination-v3-meta/lodging-tab.php' ); ?>

    <!-- Fishing Tab -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <?php include (plugin_dir_path( __FILE__ ) . 'inc/travel-meta/destination-v3-meta/fishing-tab.php' ); ?>

    <!-- Species Tab -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <?php include (plugin_dir_path( __FILE__ ) . 'inc/travel-meta/destination-v3-meta/species-tab.php' ); ?>

    <!-- Costs Tab -->
    <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
    <?php include (plugin_dir_path( __FILE__ ) . 'inc/travel-meta/destination-v3-meta/costs-tab.php' ); ?>
